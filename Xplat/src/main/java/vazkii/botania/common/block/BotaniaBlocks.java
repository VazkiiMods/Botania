...
public final class BotaniaBlocks {
	...
	public static void registerItemBlocks(BiConsumer<Item, ResourceLocation> r) {
		...
		r.accept(new BlockItemWithSpecialRenderer(gaiaPylon, props), Registry.BLOCK.getKey(gaiaPylon));
		...
		r.accept(new BlockItemWithSpecialRenderer(bellows, props), Registry.BLOCK.getKey(bellows));
		...
		r.accept(new BlockItemWithSpecialRenderer(corporeaIndex, props), Registry.BLOCK.getKey(corporeaIndex));
		...
		r.accept(new BlockItemWithSpecialRenderer(hourglass, props), Registry.BLOCK.getKey(hourglass));
		...
		r.accept(new BlockItemWithSpecialRenderer(teruTeruBozu, props), Registry.BLOCK.getKey(teruTeruBozu));
		r.accept(new BlockItemWithSpecialRenderer(avatar, props), Registry.BLOCK.getKey(avatar));
