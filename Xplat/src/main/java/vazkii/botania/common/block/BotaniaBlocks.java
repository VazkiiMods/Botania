...
public final class BotaniaBlocks {
	...
	public static final Block dreamwoodFunnel = make(LibBlockNames.DREAMWOOD_FUNNEL, new DreamwoodFunnelBlock(BlockBehaviour.Properties.ofFullCopy(dreamwood)));
	...
	public static void registerItemBlocks(BiConsumer<Item, ResourceLocation> r) {
		...
		r.accept(new BlockItem(dreamwoodFunnel, props), BuiltInRegistries.BLOCK.getKey(dreamwoodFunnel));
