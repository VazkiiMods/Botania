...
public final class BotaniaSounds {
	...
	public static final SoundEvent pinkinator = makeSoundEvent("the_pinkinator");
	...
	public static final SoundEvent terraPickMode = makeSoundEvent("terra_shatterer_mode");
	...
	public static final SoundEvent unholyCloak = makeSoundEvent("cloak_of_sin");
