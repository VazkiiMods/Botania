...
public final class ModItems {
	...
	public static final Item whitePetal = make(prefix("white" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.WHITE), DyeColor.WHITE, defaultBuilder()));
	public static final Item orangePetal = make(prefix("orange" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.ORANGE), DyeColor.ORANGE, defaultBuilder()));
	public static final Item magentaPetal = make(prefix("magenta" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.MAGENTA), DyeColor.MAGENTA, defaultBuilder()));
	public static final Item lightBluePetal = make(prefix("light_blue" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.LIGHT_BLUE), DyeColor.LIGHT_BLUE, defaultBuilder()));
	public static final Item yellowPetal = make(prefix("yellow" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.YELLOW), DyeColor.YELLOW, defaultBuilder()));
	public static final Item limePetal = make(prefix("lime" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.LIME), DyeColor.LIME, defaultBuilder()));
	public static final Item pinkPetal = make(prefix("pink" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.PINK), DyeColor.PINK, defaultBuilder()));
	public static final Item grayPetal = make(prefix("gray" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.GRAY), DyeColor.GRAY, defaultBuilder()));
	public static final Item lightGrayPetal = make(prefix("light_gray" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.LIGHT_GRAY), DyeColor.LIGHT_GRAY, defaultBuilder()));
	public static final Item cyanPetal = make(prefix("cyan" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.CYAN), DyeColor.CYAN, defaultBuilder()));
	public static final Item purplePetal = make(prefix("purple" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.PURPLE), DyeColor.PURPLE, defaultBuilder()));
	public static final Item bluePetal = make(prefix("blue" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.BLUE), DyeColor.BLUE, defaultBuilder()));
	public static final Item brownPetal = make(prefix("brown" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.BROWN), DyeColor.BROWN, defaultBuilder()));
	public static final Item greenPetal = make(prefix("green" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.GREEN), DyeColor.GREEN, defaultBuilder()));
	public static final Item redPetal = make(prefix("red" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.RED), DyeColor.RED, defaultBuilder()));
	public static final Item blackPetal = make(prefix("black" + LibItemNames.PETAL_SUFFIX), new ItemPetal(BotaniaBlocks.getBuriedPetal(DyeColor.BLACK), DyeColor.BLACK, defaultBuilder()));
	...
	public static final Item recordGaia1 = make(prefix(LibItemNames.RECORD_GAIA1), new ItemModRecord(1, BotaniaSounds.gaiaMusic1, unstackable().rarity(Rarity.RARE), 202));
	public static final Item recordGaia2 = make(prefix(LibItemNames.RECORD_GAIA2), new ItemModRecord(1, BotaniaSounds.gaiaMusic2, unstackable().rarity(Rarity.RARE), 227));
	...
	public static boolean isNoDespawn(Item item) {
		return item instanceof ItemManaTablet || item instanceof BandOfManaItem || item instanceof TerraShattererItem
