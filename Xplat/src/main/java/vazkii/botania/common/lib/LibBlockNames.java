...
public final class LibBlockNames {
	...
	public static final String SPREADER_REDSTONE = "pulse_mana_spreader";
	public static final String SPREADER_ELVEN = "elven_mana_spreader";
	public static final String SPREADER_GAIA = "gaia_mana_spreader";
	public static final String COVERED_INFIX = "_covered_";
	public static final String POOL = "mana_pool";
	public static final String POOL_CREATIVE = "creative_mana_pool";
	public static final String POOL_DILUTED = "diluted_mana_pool";
	public static final String POOL_FABULOUS = "fabulous_mana_pool";
