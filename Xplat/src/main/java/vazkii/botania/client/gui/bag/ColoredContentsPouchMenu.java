...
public class ColoredContentsPouchMenu extends AbstractContainerMenu implements BotaniaMenuWithLockedSlot {
	...
	public ColoredContentsPouchMenu(int containerId, Inventory playerInv, boolean isMainHand) {
		super(BotaniaItems.COLORED_CONTENTS_POUCH_MENU_TYPE, containerId);
	...
	public ItemStack quickMoveStack(Player player, int index) {
		...
		if (index < numPouchSlots) {
			...
			IntList slotCandidates = pouchItem.findCandidateSlots(player.level(), this.pouch, copyStack);
