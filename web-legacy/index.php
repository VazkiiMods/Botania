					...
					<div class="item">
					  ...
					  <div class="container">
						<div class="carousel-caption">
						  ...
						  <p>With an original, aim and time based power system, Botania has a much different feel than your typical magic or tech mod. Controlling <b>Mana</b> and seeing it flow in real time can bring a new light to your base.</p>
						  <p><a class="btn btn-lg btn-success" href="./downloads.php" role="button">Download Now</a></p>
						</div>
					  </div>
					</div>
		...
		<div class="featurettes">
			...
			<div class="row featurette">
				...
				<div class="col-md-7">
					...
					<a class="btn btn-lg btn-success" href="./downloads.php" role="button">Download Botania</a>
					</p>
				</div>
			</div>
			...
			<div class="row featurette">
				<div class="col-md-7">
						...
						<div class="video-intro">WTFG33ks' fast paced spotlights cover a good part of the mod and the latest update.</div>
						...
						<div class="video-intro">Haighyorkie's 8 part spotlight covers most of the mod, if you have the time to watch it :-)</div>
						<div class="lead youtube">
							...
							<iframe src="//www.youtube.com/embed/JLX_HmlXFZA" frameborder="0" allowfullscreen></iframe>
							<iframe src="//www.youtube.com/embed/W9EGTdakYeY" frameborder="0" allowfullscreen></iframe><br>
							<iframe src="//www.youtube.com/embed/BLna8Hfw69k" frameborder="0" allowfullscreen></iframe>
							<iframe src="//www.youtube.com/embed/MQZZmsl4o1o" frameborder="0" allowfullscreen></iframe>
