package vazkii.botania.fabric.tile;
...
public class FabricTileRedStringContainer extends TileRedStringContainer {
	...
	public FabricTileRedStringContainer(BlockPos pos, BlockState state) {
		super(pos, state);
	}

	public static Storage<ItemVariant> getStorage(TileRedStringContainer container, Direction direction) {
		if (container instanceof FabricTileRedStringContainer c) {
