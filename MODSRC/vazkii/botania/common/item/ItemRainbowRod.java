...
public class ItemRainbowRod extends ItemMod implements IManaUsingItem {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		if(!par2World.isRemote && par1ItemStack.getItemDamage() == 0 && ManaItemHandler.requestManaExact(par1ItemStack, par3EntityPlayer, MANA_COST, false)) {
			...
			while(count < 96 && (((int) lx == (int) x && (int) ly == (int) y && (int) lz == (int) z) || par2World.getBlock((int) x, (int) y, (int) z).isAir(par2World, (int) x, (int) y, (int) z)) || par2World.getBlock((int) x, (int) y, (int) z) == place) {
				for(int i = -2; i < 1; i++)
					for(int j = -2; j < 1; j++)
