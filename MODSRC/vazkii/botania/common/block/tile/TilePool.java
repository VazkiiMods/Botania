...
public class TilePool extends TileMod implements IManaPool {
    ...
    public void recieveMana(int mana) {
        ...
        if(!full) worldObj.func_147453_f(xCoord, yCoord, zCoord, worldObj.getBlock(xCoord, yCoord, zCoord));
    }
