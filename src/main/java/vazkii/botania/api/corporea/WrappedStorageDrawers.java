 ...
 *
 */
public class WrappedStorageDrawers extends WrappedInvenotryBase implements IWrappedInventory {
	...
	private List<ItemStack> iterateOverStacks(CorporeaRequest request, boolean doit) {
		...
		for (int i = 0; i < inv.getDrawerCount(); i++) {
			...
			//also this code is near duplicate to WrappedDeepStorage - keep it synchronized
