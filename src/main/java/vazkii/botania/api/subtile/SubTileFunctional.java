...
public class SubTileFunctional extends SubTileEntity {
	...
	public boolean isValidBinding() {
		return linkedPool != null && !linkedPool.isInvalid() && supertile.getWorld().isBlockLoaded(linkedPool.getPos(), false) && supertile.getWorld().getTileEntity(linkedPool.getPos()) == linkedPool;
	}
