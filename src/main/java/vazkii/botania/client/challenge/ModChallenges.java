...
public final class ModChallenges {
    ...
    public static void init() {
        ...
        addChallenge(
                EnumChallengeLevel.EASY, "pureDaisy", ItemBlockSpecialFlower.ofType(LibBlockNames.SUBTILE_PUREDAISY));
        ...
        addChallenge(
                EnumChallengeLevel.NORMAL, "orechid", ItemBlockSpecialFlower.ofType(LibBlockNames.SUBTILE_ORECHID));

        addChallenge(EnumChallengeLevel.HARD, "mobTower", new ItemStack(Items.bone));
        addChallenge(
                EnumChallengeLevel.HARD,
                "entropinnyumSetup",
