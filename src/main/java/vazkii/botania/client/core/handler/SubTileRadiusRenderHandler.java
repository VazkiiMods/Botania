...
public final class SubTileRadiusRenderHandler {
    ...
    public void onWorldRenderLast(RenderWorldLastEvent event) {
        ...
        if (!Botania.proxy.isClientPlayerWearingMonocle() || pos == null || pos.entityHit != null) return;
        int x = pos.blockX;
        int y = pos.blockY;
        int z = pos.blockZ;
        ...
        if (tile == null || !(tile instanceof ISubTileContainer)) return;
        ...
        if (descriptor.isCircle()) renderCircle(descriptor.getSubtileCoords(), descriptor.getCircleRadius());
    ...
    public void renderRectangle(AxisAlignedBB aabb) {
        GL11.glPushMatrix();
        GL11.glTranslated(
                aabb.minX - RenderManager.renderPosX,
                aabb.minY - RenderManager.renderPosY,
