...
public final class DebugHandler {
    ...
    public void onDrawDebugText(RenderGameOverlayEvent.Text event) {
        ...
        if (Minecraft.getMinecraft().gameSettings.showDebugInfo) {
            ...
            if (version.contains("GRADLE")) version = "N/A";

            event.left.add(PREFIX + "pS: " + ParticleRenderDispatcher.sparkleFxCount + ", pFS: "
            ...
            if (GuiScreen.isCtrlKeyDown() && GuiScreen.isShiftKeyDown()) {
                ...
                event.left.add("  GL_MAX_TEXTURE_IMAGE_UNITS_ARB: "
            ...
            } else if (Minecraft.isRunningOnMac) event.left.add(PREFIX + "SHIFT+CMD for context");
