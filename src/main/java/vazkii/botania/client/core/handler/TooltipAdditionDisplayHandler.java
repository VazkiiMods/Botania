...
public final class TooltipAdditionDisplayHandler {
            ...
            if (slot != null && slot.getHasStack()) {
                ...
                if (stack != null) {
                    ...
                    if (stack.getItem() instanceof ItemTerraPick)
                        ...
                        drawManaBar(
                                stack,
                                (IManaTooltipDisplay) stack.getItem(),
                                mouseX,
                                mouseY,
                                offx,
                                offy,
                    ...
                    if (data != null) {
                        ...
                        for (int i = 0; i < InventoryPlayer.getHotbarSize(); i++) {
                            ...
                            if (stackAt != null
                                    && stackAt.getItem() instanceof ILexicon
                                    && ((ILexicon) stackAt.getItem())
                        ...
                        if (lexSlot > -1) {
                            ...
                            if (ConfigHandler.useShiftForQuickLookup
                                ...
                                float a = 0.5F
                                        + 0.2F
                                                * ((float) Math.cos((double) (ClientTickHandler.ticksInGame
                            ...
                            RenderItem.getInstance()
                                    .renderItemIntoGUI(
                                            mc.fontRenderer, mc.renderEngine, new ItemStack(ModItems.lexicon), x, y);
                            GL11.glDisable(GL11.GL_LIGHTING);
    ...
    private static void drawTerraPick(
            ItemStack stack, int mouseX, int mouseY, int offx, int offy, int width, int height, FontRenderer font) {
        ...
        GL11.glDisable(GL11.GL_DEPTH_TEST);
        Gui.drawRect(
                mouseX + offx - 1, mouseY - offy - height - 1, mouseX + offx + width + 1, mouseY - offy, 0xFF000000);
        ...
        Gui.drawRect(
                mouseX + offx + rainbowWidth, mouseY - offy - height, mouseX + offx + width, mouseY - offy, 0xFF555555);
        ...
        if (!ss) {
            ...
            font.drawStringWithShadow(
                    rank, mouseX + offx + width - font.getStringWidth(rank), mouseY - offy - 12, 0xFFFFFF);
        }
        GL11.glEnable(GL11.GL_DEPTH_TEST);
        GL11.glPopAttrib();
    }
    ...
    private static void drawManaBar(
        ...
        Gui.drawRect(
                mouseX + offx,
                mouseY - offy - height,
                mouseX + offx + manaBarWidth,
                mouseY - offy,
                Color.HSBtoRGB(
                        0.528F,
                        ((float) Math.sin((ClientTickHandler.ticksInGame + ClientTickHandler.partialTicks) * 0.2) + 1F)
                                        * 0.3F
                                + 0.4F,
                        1F));
        Gui.drawRect(
                mouseX + offx + manaBarWidth, mouseY - offy - height, mouseX + offx + width, mouseY - offy, 0xFF555555);
    }
}
