...
public final class RenderHelper {
    ...
    public static void drawTexturedModalRect(
            int par1, int par2, float z, int par3, int par4, int par5, int par6, float f, float f1) {
    ...
    public static void renderProgressPie(int x, int y, float progress, ItemStack stack) {
        ...
        float a = 0.5F
                + 0.2F
                        * ((float) Math.cos((double) (ClientTickHandler.ticksInGame + ClientTickHandler.partialTicks)
                                                / 10)
                                        * 0.5F
                                + 0.5F);
