...
public final class LibResources {
	...
	public static final String MODEL_MANASTEEL_NEW = PREFIX_MODEL + "manasteel_new.png";
	...
	public static final String MODEL_TERRASTEEL_NEW = PREFIX_MODEL + "terrasteel_new.png";
	...
	public static final String MODEL_ELEMENTIUM_NEW = PREFIX_MODEL + "elementium_new.png";
	...
	public static final String MODEL_MANAWEAVE_NEW = PREFIX_MODEL + "manaweave_new.png";
	public static final String MODEL_MANAWEAVE_NEW_HOLIDAY = PREFIX_MODEL + "manaweave_new_holiday.png";
