...
public class GuiButtonChallengeIcon extends GuiButtonLexicon {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        ...
        RenderItem.getInstance()
                .renderItemIntoGUI(
                        par1Minecraft.fontRenderer, par1Minecraft.renderEngine, challenge.icon, xPosition, yPosition);
        ...
        if (k == 2) vazkii.botania.client.core.helper.RenderHelper.renderTooltip(par2, par3 + tooltipY, tooltip);
    }
}
