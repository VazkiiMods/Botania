...
public class GuiLexiconEntry extends GuiLexicon implements IGuiLexiconEntry, IParented {
    ...
    public void onInitGui() {
        ...
        if (entry.getWebLink() != null) buttonList.add(new GuiButtonViewOnline(4, left - 8, top + 12));
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        ...
        if (par1GuiButton.id >= BOOKMARK_START) handleBookmark(par1GuiButton);
            ...
            switch (par1GuiButton.id) {
                ...
                case 4:
                    try {
                        if (Desktop.isDesktopSupported()) Desktop.getDesktop().browse(new URI(entry.getWebLink()));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
            }
    ...
    public void updatePageButtons() {
        ...
        if (firstEntry) backButton.enabled = !rightButton.enabled;
    }
    ...
    public void updateScreen() {
        ...
        if (this.page == entry.pages.size() - 1) {
            ...
            if (entry == this.entry) {
                ...
                if (tutorial.isEmpty()) {
                    mc.thePlayer.addChatMessage(new ChatComponentTranslation("botaniamisc.tutorialEnded")
    ...
    public void positionTutorialArrow() {
        ...
        if (rightButton.enabled && rightButton.visible) orientTutorialArrowWithButton(rightButton);
    }
