...
public class GuiButtonInvisible extends GuiButtonLexicon {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        if (enableDog) {
            ...
            vazkii.botania.client.core.helper.RenderHelper.drawTexturedModalRect(
                    0, yPosition, zLevel + 10, (dogPos % 100 < 50) ? 23 : 0, 0, 23, 19, f, f);
        ...
        par1Minecraft.fontRenderer.drawString(
                displayString, xPosition + (showStack ? 7 : 0), yPosition + (height - 8) / 2, 0);
