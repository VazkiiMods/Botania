...
public class GuiButtonBookmark extends GuiButtonLexicon {
    ...
    public void drawButton(Minecraft mc, int par2, int par3) {
        ...
        if (displayString.equals("+")) tooltip.add(StatCollector.translateToLocal("botaniamisc.clickToAdd"));
        else {
            tooltip.add(String.format(
                    StatCollector.translateToLocal("botaniamisc.bookmark"), id - GuiLexicon.BOOKMARK_START + 1));
