...
public class RecipeHandlerManaPool extends TemplateRecipeHandler {
    ...
    public class CachedManaPoolRecipe extends CachedRecipe {
        ...
        public CachedManaPoolRecipe(RecipeManaInfusion recipe) {
            ...
            inputs.add(new PositionedStack(
                    new ItemStack(
                            ModBlocks.pool,
                            1,
    ...
    public void drawBackground(int recipe) {
        ...
        HUDHandler.renderManaBar(
                32, 80, 0x0000FF, 0.75F, ((CachedManaPoolRecipe) arecipes.get(recipe)).mana, TilePool.MAX_MANA / 10);
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        for (RecipeManaInfusion recipe : BotaniaAPI.manaInfusionRecipes) {
            ...
            if (ItemNBTHelper.cachedRecipeContainsWithNBT(crecipe.getIngredients(), ingredient)
                    || ItemNBTHelper.cachedRecipeContainsWithNBT(crecipe.getOtherStacks(), ingredient))
