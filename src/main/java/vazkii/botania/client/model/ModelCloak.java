...
public class ModelCloak extends Model {
	...
	public RendererModel sideL;
	public RendererModel sideR;
	...
	public ModelCloak() {
		...
		collar = new RendererModel(this, 0, 0);
		...
		sideL = new RendererModel(this, 0, 16);
        sideL.mirror = true;
        ...
        sideR = new RendererModel(this, 0, 16);
