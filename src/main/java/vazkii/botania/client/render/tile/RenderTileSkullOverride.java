...
public class RenderTileSkullOverride extends TileEntitySkullRenderer {
    ...
    public void renderTileEntityAt(
        ...
        render(
                ...
                (float) p_147500_4_,
                (float) p_147500_6_,
                p_147500_1_.getBlockMetadata() & 7,
                p_147500_1_.func_145906_b() * 360 / 16.0F,
                p_147500_1_.func_145904_a(),
    ...
    public void render(
        ...
        if (par6 == 3 || gaia) {
            ...
            if (gaia) resourcelocation = minecraft.thePlayer.getLocationSkin();
            ...
            if (gaia) ShaderHelper.useShader(ShaderHelper.doppleganger, RenderDoppleganger.defaultCallback);

            modelSkull.render(null, 0F, 0F, 0F, par5, 0F, 0.0625F);

            if (gaia) ShaderHelper.releaseShader();
            GL11.glPopMatrix();
