...
public class SkyblockSkyRenderer extends IRenderHandler {
    ...
    private static final ResourceLocation textureMoonPhases =
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        int glSkyList =
                ReflectionHelper.getPrivateValue(RenderGlobal.class, mc.renderGlobal, LibObfuscation.GL_SKY_LIST);
        int glSkyList2 = ReflectionHelper.getPrivateValue(
                RenderGlobal.class,
                mc.renderGlobal,
                LibObfuscation.GL_SKY_LIST2); // Horizon line. We don't have it here
        int starGLCallList =
                ReflectionHelper.getPrivateValue(RenderGlobal.class, mc.renderGlobal, LibObfuscation.STAR_GL_CALL_LIST);
        ...
        if (afloat != null) {
            ...
            for (int j = 0; j <= b0; ++j) {
                ...
                tessellator1.addVertex(
                        (double) (f12 * 120.0F), (double) (f13 * 120.0F), (double) (-f13 * 40.0F * afloat[3]));
            }
        ...
        for (int p = 0; p < 3; p++) {
            ...
            GL11.glRotatef(
                    (ClientTickHandler.ticksInGame + ClientTickHandler.partialTicks) * 0.25F * rotSpeed * rotSpeedMod,
                    0F,
                    1F,
                    0F);
