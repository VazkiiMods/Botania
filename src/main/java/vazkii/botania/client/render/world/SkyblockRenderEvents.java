...
public final class SkyblockRenderEvents {
	...
	public void onRender(RenderWorldLastEvent event) {
		...
		if(ConfigHandler.enableFancySkybox && world.provider.getDimensionId() == 0 && (ConfigHandler.enableFancySkyboxInNormalWorlds || WorldTypeSkyblock.isWorldSkyblock(Minecraft.getMinecraft().theWorld))) {
