...
public class RenderSpecialFlower implements ISimpleBlockRenderingHandler, IMultiblockRenderHook {
    ...
    public static boolean renderCrossedSquares(
            IBlockAccess blockAccess, Block par1Block, int par2, int par3, int par4, RenderBlocks render) {
    ...
    // Copied from RenderBlocks
    public static void drawCrossedSquares(
    ...
    @Override
    public void renderBlockForMultiblock(
            IBlockAccess world,
            Multiblock mb,
            Block block,
            int meta,
