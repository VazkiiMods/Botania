...
public class RenderLexicon implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (ticks > 0 && ticks < 10) {
            if (mc.currentScreen instanceof GuiLexicon) ticks += ClientTickHandler.partialTicks;
        ...
        if (pageFlipTicks > 0) pageFlipTicks -= ClientTickHandler.partialTicks;
        ...
        if (ticks < 3) {
            ...
            boolean bevo =
                    Minecraft.getMinecraft().thePlayer.getCommandSenderName().equalsIgnoreCase("BevoLJ");
            boolean saice =
                    Minecraft.getMinecraft().thePlayer.getCommandSenderName().equalsIgnoreCase("saice");
            ...
            if (Minecraft.getMinecraft().thePlayer.getCurrentEquippedItem() != null)
                title = Minecraft.getMinecraft()
                        .thePlayer
                        .getCurrentEquippedItem()
                        .getDisplayName();
            if (title.equals(origTitle) && bevo) title = StatCollector.translateToLocal("item.botania:lexicon.bevo");
            if (title.equals(origTitle) && saice) title = StatCollector.translateToLocal("item.botania:lexicon.saice");

            font.drawString(font.trimStringToWidth(title, 80), 0, 0, 0xD69700);
            GL11.glTranslatef(0F, 10F, 0F);
            GL11.glScalef(0.6F, 0.6F, 0.6F);
            font.drawString(
                    EnumChatFormatting.ITALIC + "" + EnumChatFormatting.BOLD
                            + String.format(
                                    StatCollector.translateToLocal("botaniamisc.edition"), ItemLexicon.getEdition()),
                    0,
                    0,
                    0xA07100);
            ...
            GL11.glTranslatef(0F, 10F, 0F);
            font.drawString(
                    EnumChatFormatting.UNDERLINE + "" + EnumChatFormatting.ITALIC
                            + StatCollector.translateToLocal("botaniamisc.lexiconcover3"),
                    0,
                    0,
                    0x79ff92);
            if (bevo || saice) {
                GL11.glTranslatef(0F, 10F, 0F);
                font.drawString(
                        StatCollector.translateToLocal("botaniamisc.lexiconcover" + (bevo ? 4 : 5)), 0, 0, 0x79ff92);
            }
        }
