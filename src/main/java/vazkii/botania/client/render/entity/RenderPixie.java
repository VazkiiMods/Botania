...
public class RenderPixie extends RenderLiving {
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        ...
        if (pixie.getType() == 1) ShaderHelper.useShader(ShaderHelper.doppleganger, callback);
        super.doRender(par1Entity, par2, par4, par6, par8, par9);
        if (pixie.getType() == 1) ShaderHelper.releaseShader();
    }
    ...
    protected int setPixieBrightness(EntityPixie par1EntityPixie, int par2, float par3) {
        if (par2 != 0) return -1;
            ...
            if (par1EntityPixie.isInvisible()) GL11.glDepthMask(false);
