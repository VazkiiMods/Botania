...
public class PageShedding extends PageEntity {
    ...
    public void renderScreen(IGuiLexiconEntry gui, int mx, int my) {
        ...
        int entity_y =
                gui.getTop() + gui.getHeight() / 2 + MathHelper.floor_float(dummyEntity.height * entity_scale / 2) - 29;
    ...
    public void renderItem(IGuiLexiconEntry gui, int xPos, int yPos, ItemStack stack) {
        ...
        render.renderItemAndEffectIntoGUI(
                Minecraft.getMinecraft().fontRenderer, Minecraft.getMinecraft().getTextureManager(), stack, xPos, yPos);
