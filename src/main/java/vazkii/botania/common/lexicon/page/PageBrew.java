...
public class PageBrew extends PageRecipe implements ITwoNamedPage {
    ...
    public void renderRecipe(IGuiLexiconEntry gui, int mx, int my) {
        ...
        String s = EnumChatFormatting.BOLD
                + String.format(
                        StatCollector.translateToLocal("botaniamisc.brewOf"),
                        StatCollector.translateToLocal(brew.getUnlocalizedName()));
        ...
        if (book != null
                ...
                && ((ILexicon) book.getItem()).isKnowledgeUnlocked(book, BotaniaAPI.elvenKnowledge)) {
