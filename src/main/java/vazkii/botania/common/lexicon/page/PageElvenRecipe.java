...
public class PageElvenRecipe extends PageRecipe {
    ...
    private static final ResourceLocation elvenTradeOverlay =
            new ResourceLocation(LibResources.GUI_ELVEN_TRADE_OVERLAY);
    ...
    public List<ItemStack> getDisplayedRecipes() {
        ...
        for (RecipeElvenTrade r : recipes) list.add(r.getOutput());
