...
public final class ModRuneRecipes {
    ...
    public static void init() {
        ...
        recipeWaterRune = BotaniaAPI.registerRuneAltarRecipe(
        ...
        recipeFireRune = BotaniaAPI.registerRuneAltarRecipe(
        ...
        recipesEarthRune.add(BotaniaAPI.registerRuneAltarRecipe(
        ...
        for (int i = 0; i < 16; i++)
            recipesAirRune.add(BotaniaAPI.registerRuneAltarRecipe(
        ...
        recipeSpringRune = BotaniaAPI.registerRuneAltarRecipe(
        ...
        recipeSummerRune = BotaniaAPI.registerRuneAltarRecipe(
        ...
        recipeAutumnRune = BotaniaAPI.registerRuneAltarRecipe(
        ...
        for (int i = 0; i < 16; i++)
            recipesWinterRune.add(BotaniaAPI.registerRuneAltarRecipe(
        ...
        recipeManaRune = BotaniaAPI.registerRuneAltarRecipe(
        ...
        recipeLustRune = BotaniaAPI.registerRuneAltarRecipe(
                ...
                LibOreDict.RUNE[5],
                LibOreDict.RUNE[3]);
        recipeGluttonyRune = BotaniaAPI.registerRuneAltarRecipe(
                ...
                LibOreDict.RUNE[7],
                LibOreDict.RUNE[1]);
        recipeGreedRune = BotaniaAPI.registerRuneAltarRecipe(
                ...
                LibOreDict.RUNE[4],
                LibOreDict.RUNE[0]);
        recipeSlothRune = BotaniaAPI.registerRuneAltarRecipe(
                ...
                LibOreDict.RUNE[6],
                LibOreDict.RUNE[3]);
        recipeWrathRune = BotaniaAPI.registerRuneAltarRecipe(
                ...
                LibOreDict.RUNE[7],
                LibOreDict.RUNE[2]);
        recipeEnvyRune = BotaniaAPI.registerRuneAltarRecipe(
                ...
                LibOreDict.RUNE[7],
                LibOreDict.RUNE[0]);
        recipePrideRune = BotaniaAPI.registerRuneAltarRecipe(
