...
public class HelmRevealingRecipe implements IRecipe {
    ...
    public boolean matches(InventoryCrafting var1, World var2) {
        ...
        if (goggles == null) return false; // NO TC loaded
        ...
        for (int i = 0; i < var1.getSizeInventory(); i++) {
            ...
            if (stack != null) {
                if (checkHelm(stack)) foundHelm = true;
                else if (stack.getItem() == goggles) foundGoggles = true;
    ...
    public ItemStack getCraftingResult(InventoryCrafting var1) {
        ...
        for (int i = 0; i < var1.getSizeInventory(); i++) {
            ItemStack stack = var1.getStackInSlot(i);
            if (stack != null && checkHelm(stack)) helm = stack;
        }
        ...
        if (helmItem == ModItems.manasteelHelm) newHelm = new ItemStack(ModItems.manasteelHelmRevealing);
        else if (helmItem == ModItems.terrasteelHelm) newHelm = new ItemStack(ModItems.terrasteelHelmRevealing);
        else if (helmItem == ModItems.elementiumHelm) newHelm = new ItemStack(ModItems.elementiumHelmRevealing);
        else return null;
        ...
        if (enchList != null) ItemNBTHelper.setList(newHelm, "ench", enchList);
    ...
    private boolean checkHelm(ItemStack helmStack) {
        ...
        return helmItem == ModItems.manasteelHelm
                || helmItem == ModItems.terrasteelHelm
                || helmItem == ModItems.elementiumHelm;
    }
}
