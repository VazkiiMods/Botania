...
public final class ModCraftingRecipes {
    ...
    public static void init() {
        ...
        for (int i = 0; i < 16; i++)
            addShapelessOreDictRecipe(
                    new ItemStack(ModItems.dye, 1, i), LibOreDict.PETAL[i], LibOreDict.PESTLE_AND_MORTAR);
        recipesDyes = BotaniaAPI.getLatestAddedRecipes(16);

        // Petal Block Recipes
        for (int i = 0; i < 16; i++)
            addOreDictRecipe(
                    new ItemStack(ModBlocks.petalBlock, 1, i),
                    "PPP",
                    "PPP",
                    "PPP", // PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP
                    'P',
                    LibOreDict.PETAL[i]);
        ...
        addOreDictRecipe(
                new ItemStack(ModItems.pestleAndMortar),
                " S",
                "W ",
                "B ",
                'S',
        ...
        for (int i = 0; i < 16; i++)
            addOreDictRecipe(
                    ...
                    LibOreDict.PETAL[i],
                    'G',
                    Botania.gardenOfGlassLoaded ? LibOreDict.LIVING_WOOD : "ingotGold");
        ...
        addOreDictRecipe(
                new ItemStack(ModBlocks.pool, 1, 2), "R R", "RRR", 'R', new ItemStack(ModFluffBlocks.livingrockSlab));
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModItems.lens, 1, 8), new ItemStack(ModItems.lens), LibOreDict.RUNE[13]);
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModItems.lens, 1, 10), new ItemStack(ModItems.lens), "ingotIron", "ingotGold");
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModBlocks.livingrock, 1, 2),
                new ItemStack(ModBlocks.livingrock, 1, 1),
                new ItemStack(Items.wheat_seeds));
        recipeLivingrockDecor2 = BotaniaAPI.getLatestAddedRecipe();
        addShapelessOreDictRecipe(
                new ItemStack(ModBlocks.livingrock, 2, 3), new ItemStack(ModBlocks.livingrock, 1, 1), "cobblestone");
        recipeLivingrockDecor3 = BotaniaAPI.getLatestAddedRecipe();
        addOreDictRecipe(
                new ItemStack(ModBlocks.livingrock, 4, 4), "RR", "RR", 'R', new ItemStack(ModBlocks.livingrock, 1, 1));
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModBlocks.livingwood, 1, 2),
                new ItemStack(ModBlocks.livingwood, 1, 1),
                new ItemStack(Items.wheat_seeds));
        recipeLivingwoodDecor2 = BotaniaAPI.getLatestAddedRecipe();
        addOreDictRecipe(
                new ItemStack(ModBlocks.livingwood, 4, 3), "WW", "WW", 'W', new ItemStack(ModBlocks.livingwood, 1, 1));
        recipeLivingwoodDecor3 = BotaniaAPI.getLatestAddedRecipe();
        addOreDictRecipe(
                new ItemStack(ModBlocks.livingwood, 4, 4),
                " W ",
                "W W",
                " W ",
                'W',
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModBlocks.dreamwood, 1, 2),
                new ItemStack(ModBlocks.dreamwood, 1, 1),
                new ItemStack(Items.wheat_seeds));
        addOreDictRecipe(
                new ItemStack(ModBlocks.dreamwood, 4, 3), "WW", "WW", 'W', new ItemStack(ModBlocks.dreamwood, 1, 1));
        addOreDictRecipe(
                new ItemStack(ModBlocks.dreamwood, 4, 4),
                " W ",
                "W W",
                " W ",
                'W',
        ...
        // Mana Tablet Recipe
        addOreDictRecipe(
                new ItemStack(ModItems.manaTablet, 1, 10000),
                "SSS",
                "SPS",
                "SSS",
                'S',
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(ModItems.fertilizer, Botania.gardenOfGlassLoaded ? 3 : 1),
                new ItemStack(Items.dye, 1, 15),
                new ItemStack(ModItems.dye, 1, Short.MAX_VALUE),
                new ItemStack(ModItems.dye, 1, Short.MAX_VALUE),
                new ItemStack(ModItems.dye, 1, Short.MAX_VALUE),
                new ItemStack(ModItems.dye, 1, Short.MAX_VALUE));
        ...
        GameRegistry.addRecipe(new ShapelessOreRecipe(
                new ItemStack(ModBlocks.spreader, 1, 1), new ItemStack(ModBlocks.spreader), "dustRedstone"));
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModItems.manaRingGreater), LibOreDict.TERRA_STEEL, new ItemStack(ModItems.manaRing));
        recipeGreaterManaRing = BotaniaAPI.getLatestAddedRecipe();

        // Greater Aura Band Recipe
        addShapelessOreDictRecipe(
                new ItemStack(ModItems.auraRingGreater), LibOreDict.TERRA_STEEL, new ItemStack(ModItems.auraRing));
        ...
        GameRegistry.addRecipe(new ShapelessOreRecipe(
                new ItemStack(ModItems.manaResource, 1, 6), "dustRedstone", new ItemStack(Blocks.tallgrass, 1, 1)));
        ...
        if (ConfigHandler.darkQuartzEnabled)
            recipeDarkQuartz = addQuartzRecipes(
                    0,
                    Items.coal,
        ...
        addQuartzRecipes(
                1, null, ModFluffBlocks.manaQuartz, ModFluffBlocks.manaQuartzStairs, ModFluffBlocks.manaQuartzSlab);
        recipeBlazeQuartz = addQuartzRecipes(
                2,
                Items.blaze_powder,
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(ModItems.quartz, 8, 3),
                "QQQ",
                "QCQ",
                "QQQ",
                'Q',
        ...
        recipeRedQuartz = addQuartzRecipes(
                4,
                Items.redstone,
        ...
        addQuartzRecipes(
                5, null, ModFluffBlocks.elfQuartz, ModFluffBlocks.elfQuartzStairs, ModFluffBlocks.elfQuartzSlab);

        recipeSunnyQuartz = addQuartzRecipes(
                6,
        ...
        // Vine Ball Recipe
        addOreDictRecipe(new ItemStack(ModItems.vineBall), "VVV", "VVV", "VVV", 'V', new ItemStack(Blocks.vine));
        ...
        // Moss Stone Recipe
        addShapelessOreDictRecipe(
                new ItemStack(Blocks.mossy_cobblestone), "cobblestone", new ItemStack(ModItems.vineBall));
        recipeMossStone = BotaniaAPI.getLatestAddedRecipe();

        // Prismarine Recipe
        addOreDictRecipe(
                new ItemStack(ModBlocks.prismarine, 1, 0),
                " S ",
                "SBS",
                " S ",
                'S',
        ...
        addOreDictRecipe(
                new ItemStack(ModBlocks.prismarine, 1, 1),
                " S ",
                "SBS",
                " S ",
                'S',
        ...
        for (int i = 0; i < 16; i++)
            addOreDictRecipe(
                    new ItemStack(ModItems.laputaShard),
                    "SFS",
                    "PDP",
                    "ASE",
                    'S',
        ...
        for (int i = 1; i < 20; i++)
            addShapelessOreDictRecipe(
                    new ItemStack(ModItems.laputaShard, 1, i),
                    LibOreDict.LIFE_ESSENCE,
                    new ItemStack(ModItems.laputaShard, 1, i - 1));
        recipesLaputaShardUpgrade = BotaniaAPI.getLatestAddedRecipes(19);

        // Necrodermal Virus Recipe
        addShapelessOreDictRecipe(
                new ItemStack(ModItems.virus),
                LibOreDict.PIXIE_DUST,
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModItems.manaResource, 32, 11), "craftingTableWood", LibOreDict.LIVING_ROCK);
        recipePlaceholder = BotaniaAPI.getLatestAddedRecipe();

        // Reed Block Recipe
        GameRegistry.addRecipe(
                new ItemStack(ModBlocks.reedBlock), "rrr", "rrr", "rrr", 'r', new ItemStack(Items.reeds));
        recipeReedBlock = BotaniaAPI.getLatestAddedRecipe();

        // Thatch Recipe
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.thatch), "ww", "ww", 'w', "cropWheat"));
        recipeThatch = BotaniaAPI.getLatestAddedRecipe();

        // Nether Brick Recipe
        GameRegistry.addRecipe(
                new ItemStack(ModBlocks.customBrick, 4, 0),
                " B ",
                "BSB",
                " B ",
                'B',
        ...
        // Soul Brick Recipe
        GameRegistry.addRecipe(
                new ItemStack(ModBlocks.customBrick, 4, 1),
                " B ",
                "BSB",
                " B ",
                'B',
        ...
        // Snow Brick Recipe
        GameRegistry.addRecipe(
                new ItemStack(ModBlocks.customBrick, 4, 2),
                " B ",
                "BSB",
                " B ",
                'B',
        ...
        // Roof Tile Recipe
        GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(ModBlocks.customBrick, 4, 3), "BB", "BB", "BB", 'B', "ingotBrick"));
        recipeRoofTile = BotaniaAPI.getLatestAddedRecipe();

        // Azulejo Recipe
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(new ItemStack(ModBlocks.customBrick, 1, 4), "gemLapis", "blockQuartz"));
        ...
        addOreDictRecipe(
                new ItemStack(ModItems.enderHand),
                "PLO",
                "LEL",
                "OL ",
                'P',
        ...
        // Vial Recipe
        GameRegistry.addRecipe(
                new ItemStack(ModItems.vial, 3, 0), "G G", " G ", 'G', new ItemStack(ModBlocks.manaGlass));
        recipeVial = BotaniaAPI.getLatestAddedRecipe();

        // Flask Recipe
        GameRegistry.addRecipe(
                new ItemStack(ModItems.vial, 3, 1), "G G", " G ", 'G', new ItemStack(ModBlocks.elfGlass));
        ...
        addOreDictRecipe(new ItemStack(ModItems.manaResource, 1, 13), "W", "W", 'W', LibOreDict.DREAM_WOOD);
        ...
        // Trodden Dirt Slab
        GameRegistry.addRecipe(
                new ItemStack(ModFluffBlocks.dirtPathSlab, 6), "DDD", 'D', new ItemStack(ModBlocks.dirtPath));
        ...
        addOreDictRecipe(
                new ItemStack(ModItems.livingwoodBow),
                " TS",
                "T S",
                " TS",
                'T',
        ...
        for (int i = 0; i < 32; i++)
            addOreDictRecipe(
                    new ItemStack(ModItems.cosmetic, 1, i),
                    "PPP",
                    "PSP",
                    "PPP",
                    'P',
                    new ItemStack(i < 16 ? ModItems.petal : ModItems.dye, 1, i % 16),
                    'S',
                    LibOreDict.MANA_STRING);
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(ModItems.poolMinecart), new ItemStack(Items.minecart), new ItemStack(ModBlocks.pool));
        ...
        addOreDictRecipe(
                ...
                "BBB",
                'B',
                Botania.gardenOfGlassLoaded ? "powderBlaze" : "rodBlaze");
        recipeBlazeBlock = BotaniaAPI.getLatestAddedRecipe();
        addShapelessOreDictRecipe(
                new ItemStack(Botania.gardenOfGlassLoaded ? Items.blaze_powder : Items.blaze_rod, 9),
        ...
        addOreDictRecipe(
                new ItemStack(ModItems.temperanceStone), " S ", "SRS", " S ", 'S', "stone", 'R', LibOreDict.RUNE[2]);
        ...
        addShapelessOreDictRecipe(
                new ItemStack(ModItems.magnetRingGreater), LibOreDict.TERRA_STEEL, new ItemStack(ModItems.magnetRing));
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(ModItems.manaResource, 9, 0), new ItemStack(ModBlocks.storage, 1, 0));
        GameRegistry.addShapelessRecipe(
                new ItemStack(ModItems.manaResource, 9, 4), new ItemStack(ModBlocks.storage, 1, 1));
        GameRegistry.addShapelessRecipe(
                new ItemStack(ModItems.manaResource, 9, 7), new ItemStack(ModBlocks.storage, 1, 2));
        GameRegistry.addShapelessRecipe(
                new ItemStack(ModItems.manaResource, 9, 2), new ItemStack(ModBlocks.storage, 1, 3));
        GameRegistry.addShapelessRecipe(
                new ItemStack(ModItems.manaResource, 9, 9), new ItemStack(ModBlocks.storage, 1, 4));

        addOreDictRecipe(
                new ItemStack(ModItems.manaResource, 1, 0), "III", "III", "III", 'I', LibOreDict.MANASTEEL_NUGGET);
        addOreDictRecipe(
                new ItemStack(ModItems.manaResource, 1, 4), "III", "III", "III", 'I', LibOreDict.TERRASTEEL_NUGGET);
        addOreDictRecipe(
                new ItemStack(ModItems.manaResource, 1, 7), "III", "III", "III", 'I', LibOreDict.ELEMENTIUM_NUGGET);
        ...
        addStairsAndSlabs(
                ModBlocks.livingwood, 1, ModFluffBlocks.livingwoodPlankStairs, ModFluffBlocks.livingwoodPlankSlab);
        addStairsAndSlabs(ModBlocks.livingrock, 0, ModFluffBlocks.livingrockStairs, ModFluffBlocks.livingrockSlab);
        addStairsAndSlabs(
                ModBlocks.livingrock, 1, ModFluffBlocks.livingrockBrickStairs, ModFluffBlocks.livingrockBrickSlab);
        addStairsAndSlabs(ModBlocks.dreamwood, 0, ModFluffBlocks.dreamwoodStairs, ModFluffBlocks.dreamwoodSlab);
        addStairsAndSlabs(
                ModBlocks.dreamwood, 1, ModFluffBlocks.dreamwoodPlankStairs, ModFluffBlocks.dreamwoodPlankSlab);
        addStairsAndSlabs(ModBlocks.prismarine, 0, ModFluffBlocks.prismarineStairs, ModFluffBlocks.prismarineSlab);
        addStairsAndSlabs(
                ModBlocks.prismarine, 1, ModFluffBlocks.prismarineBrickStairs, ModFluffBlocks.prismarineBrickSlab);
        addStairsAndSlabs(
                ModBlocks.prismarine, 2, ModFluffBlocks.darkPrismarineStairs, ModFluffBlocks.darkPrismarineSlab);
        ...
        addStairsAndSlabs(
                ModBlocks.shimmerwoodPlanks,
                0,
                ModFluffBlocks.shimmerwoodPlankStairs,
                ModFluffBlocks.shimmerwoodPlankSlab);
        ...
        for (int i = 0; i < 8; i++) addWall(ModFluffBlocks.biomeStoneA, i + 8, ModFluffBlocks.biomeStoneWall, i);
        for (int i = 0; i < 4; i++) addWall(ModFluffBlocks.stone, i, ModFluffBlocks.stoneWall, i);
        ...
        for (int i = 0; i < 8; i++) {
            ...
            addStairsAndSlabs(
                    ...
                    i,
                    ModFluffBlocks.biomeStoneStairs[i],
                    ModFluffBlocks.biomeStoneSlabs[i]);
            addStairsAndSlabs(
                    ModFluffBlocks.biomeStoneA,
                    i + 8,
                    ModFluffBlocks.biomeStoneStairs[i + 8],
                    ModFluffBlocks.biomeStoneSlabs[i + 8]);
            addStairsAndSlabs(
                    ModFluffBlocks.biomeStoneB,
                    i,
                    ModFluffBlocks.biomeStoneStairs[i + 16],
                    ModFluffBlocks.biomeStoneSlabs[i + 16]);
        }

        // 1.8 Block Stone Stairs & Slabs
        for (int i = 0; i < 4; i++) {
            addOreDictRecipe(
                    new ItemStack(ModFluffBlocks.stoneSlabs[i], 6), "QQQ", 'Q', LibOreDict.STONE_18_VARIANTS[i]);
            addOreDictRecipe(
                    new ItemStack(ModFluffBlocks.stoneStairs[i], 4),
                    "  Q",
                    " QQ",
                    "QQQ",
                    'Q',
            ...
            addOreDictRecipe(
                    new ItemStack(ModFluffBlocks.stoneSlabs[i + 4], 6),
                    "QQQ",
                    'Q',
                    LibOreDict.STONE_18_VARIANTS[i + 8]);
            addOreDictRecipe(
                    new ItemStack(ModFluffBlocks.stoneStairs[i + 4], 4),
                    "  Q",
                    " QQ",
                    "QQQ",
                    'Q',
            ...
            addOreDictRecipe(
                    ...
                    LibOreDict.STONE_18_VARIANTS[i + 8]);
            addOreDictRecipe(
                    new ItemStack(ModFluffBlocks.stone, 1, i + 8), // VERY 		VERY
                    "Q",
                    "Q", // BIG		BIG
                    'Q',
                    new ItemStack(ModFluffBlocks.stoneSlabs[i + 4])); // PROBLEM	PROBLEM
        }

        // Pavement Stairsm & Stairs
        for (int i = 0; i < ModFluffBlocks.pavementStairs.length; i++)
            addStairsAndSlabs(
                    ModFluffBlocks.pavement, i, ModFluffBlocks.pavementStairs[i], ModFluffBlocks.pavementSlabs[i]);
        ...
        if (Botania.gardenOfGlassLoaded) initGardenOfGlass();
    ...
    private static void initGardenOfGlass() {
        // Root to Sapling
        addShapelessOreDictRecipe(
                new ItemStack(Blocks.sapling), LibOreDict.ROOT, LibOreDict.ROOT, LibOreDict.ROOT, LibOreDict.ROOT);
        ...
        addShapelessOreDictRecipe(
                new ItemStack(Items.slime_ball), new ItemStack(Items.magma_cream), new ItemStack(Items.water_bucket));
    ...
    private static void addStairsAndSlabs(Block block, int meta, Block stairs, Block slab) {
        GameRegistry.addRecipe(new ItemStack(slab, 6), "QQQ", 'Q', new ItemStack(block, 1, meta));
        GameRegistry.addRecipe(new ItemStack(stairs, 4), "  Q", " QQ", "QQQ", 'Q', new ItemStack(block, 1, meta));
        GameRegistry.addRecipe(new ItemStack(stairs, 4), "Q  ", "QQ ", "QQQ", 'Q', new ItemStack(block, 1, meta));
        GameRegistry.addRecipe(new ItemStack(block, 1, meta), "Q", "Q", 'Q', new ItemStack(slab));
    }

    private static void addWall(Block block, int blockMeta, Block wall, int wallMeta) {
        GameRegistry.addRecipe(new ItemStack(wall, 6, wallMeta), "BBB", "BBB", 'B', new ItemStack(block, 1, blockMeta));
    }

    private static void addPane(Block block, Block pane) {
        GameRegistry.addRecipe(new ItemStack(pane, 16), "BBB", "BBB", 'B', new ItemStack(block, 1));
    }

    private static IRecipe addQuartzRecipes(int meta, Item req, Block block, Block stairs, Block slab) {
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(block), "QQ", "QQ", 'Q', LibOreDict.QUARTZ[meta]));
        GameRegistry.addRecipe(new ItemStack(block, 2, 2), "Q", "Q", 'Q', block);
        GameRegistry.addRecipe(new ItemStack(block, 1, 1), "Q", "Q", 'Q', slab);
        addStairsAndSlabs(block, 0, stairs, slab);

        if (req != null) {
            if (req == Items.coal)
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        new ItemStack(ModItems.quartz, 8, meta),
                        "QQQ",
                        "QCQ",
                        "QQQ",
                        'Q',
                        "gemQuartz",
                        'C',
                        new ItemStack(req, 1, 1)));
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    new ItemStack(ModItems.quartz, 8, meta), "QQQ", "QCQ", "QQQ", 'Q', "gemQuartz", 'C', req));
