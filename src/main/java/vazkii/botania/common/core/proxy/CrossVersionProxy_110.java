...
public class CrossVersionProxy_110 implements ICrossVersionProxy {
    ...
    public TileEntity createTeFromCompound(World world, NBTTagCompound compound) {
        ...
        try {
            ...
            Botania.LOGGER.error("Couldn't create TE in 1.10 crossversion proxy");
            return null;
        }
    }
    ...
    public void copyGameType(PlayerControllerMP from, BotaniaPlayerController to) {
        try {
            ...
            Botania.LOGGER.error("Couldn't copy gametype in 1.10 crossversion proxy");
        }
    }
    ...
    public int getSkeletonTypeInt(EntitySkeleton skeleton) {
        try {
            ...
            Botania.LOGGER.error("Couldn't get skeleton type in 1.10 crossversion proxy");
            return 0;
        }
    }
    ...
    public void setSkeletonTypeInt(EntitySkeleton skeleton, int type) {
        try {
            ...
            Botania.LOGGER.error("Couldn't set skeleton type in 1.10 crossversion proxy");
        }
    }
    ...
    public boolean isSurvivalOrAdventure(EntityPlayerMP playerMP) {
        try {
            ...
            Botania.LOGGER.error("Couldn't determine survival or adventure in 1.10 crossversion proxy");
            return true;
        }
    }
}
