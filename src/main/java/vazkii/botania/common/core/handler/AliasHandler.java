...
public final class AliasHandler {
    ...
    public static void onMissingMappings(FMLMissingMappingsEvent event) {
        ...
        for (MissingMapping mapping : mappings) {
            ...
            if (mapping.type == Type.ITEM) remapItem(mapping, getItem(name));
    ...
    private static Item getItem(String name) {
        for (Object o : Item.itemRegistry.getKeys()) {
            ...
            if (i.getUnlocalizedName().substring("item.".length()).equals(name)) return i;
        }
    ...
    private static Block getBlock(String name) {
        for (Object o : Block.blockRegistry.getKeys()) {
            ...
            if (b.getUnlocalizedName().substring("tile.".length()).equals(name)) return b;
        }
