...
public final class ConfigHandler {
    ...
    public static void load() {
        ...
        enableFancySkyboxInNormalWorlds =
                loadPropBool("fancySkybox.normalWorlds", desc, enableFancySkyboxInNormalWorlds);
        ...
        desc =
                "Set this to true to use alternate flower textures by Futureazoo, not all flowers are textured. http://redd.it/2b3o3f";
        ...
        desc =
                "Set this to false to disable the 1.9 Ender features available as recipes. This only disables the recipes and entries. Old ones that are already in the world will stay.";
        ...
        desc =
                "The amount of time it takes a Passive flower to decay and turn into a dead bush. Defaults to 72000, 60 minutes. Setting this to -1 disables the feature altogether.";
        ...
        flowerDimensionWhitelist =
                loadPropIntArray("worldgen.flower.dimensionWhitelist", desc, flowerDimensionWhitelist);

        desc = "Blacklist of which dimension generates Botania flowers.";
        flowerDimensionBlacklist =
                loadPropIntArray("worldgen.flower.dimensionBlacklist", desc, flowerDimensionBlacklist);

        desc = "Whitelist of which dimension generates Botania mushrooms. Empty means any dimension can.";
        mushroomDimensionWhitelist =
                loadPropIntArray("worldgen.mushroom.dimensionWhitelist", desc, mushroomDimensionWhitelist);

        desc = "Blacklist of which dimension generates Botania mushrooms.";
        mushroomDimensionBlacklist =
                loadPropIntArray("worldgen.mushroom.dimensionBlacklist", desc, mushroomDimensionBlacklist);
    ...
    public static int loadPropInt(String propName, String desc, int default_) {
        ...
        if (adaptor != null) adaptor.adaptPropertyInt(prop, prop.getInt(default_));
    ...
    public static double loadPropDouble(String propName, String desc, double default_) {
        ...
        if (adaptor != null) adaptor.adaptPropertyDouble(prop, prop.getDouble(default_));
    ...
    public static boolean loadPropBool(String propName, String desc, boolean default_) {
        ...
        if (adaptor != null) adaptor.adaptPropertyBool(prop, prop.getBoolean(default_));
    ...
    public static int[] loadPropIntArray(String propName, String desc, int[] intArray) {
        ...
        if (adaptor != null) adaptor.adaptPropertyIntArray(prop, prop.getIntList());

        return prop.getIntList();
    }

    public static int loadPropPotionId(String propName, int default_) {
        if (!verifiedPotionArray) verifyPotionArray();
    ...
    private static void verifyPotionArray() {
        if (Loader.isModLoaded("DragonAPI")) potionArrayLimit = Potion.potionTypes.length;
        else if (Loader.isModLoaded("hodgepodge")) potionArrayLimit = 255;
    ...
    public static class ConfigAdaptor {
        ...
        public <T> void adaptProperty(Property prop, T val) {
            ...
            if (!adaptableValues.containsKey(name)) return;

            AdaptableValue<T> bestValue = null;
            for (AdaptableValue<T> value : adaptableValues.get(name)) {
                if (bestValue == null || value.version > bestValue.version) bestValue = value;
            }
        ...
        public boolean areEqualNumbers(Object v1, Object v2) {
            ...
            if (v2 instanceof String) v2f = Float.parseFloat((String) v2);
        ...
        public void tellChanges(EntityPlayer player) {
            ...
            player.addChatComponentMessage(new ChatComponentTranslation("botaniamisc.adaptativeConfigChanges")
    ...
    public static class ChangeListener {
        ...
        public void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent eventArgs) {
            if (eventArgs.modID.equals(LibMisc.MOD_ID)) load();
        }
    }
}
