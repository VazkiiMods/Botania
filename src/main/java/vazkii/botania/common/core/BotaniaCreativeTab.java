...
public final class BotaniaCreativeTab extends CreativeTabs {
    ...
    public void displayAllReleventItems(List list) {
        ...
        if (Botania.thaumcraftLoaded) addItem(ModItems.manaInkwell);
        ...
        if (Botania.thaumcraftLoaded) addItem(ModItems.manasteelHelmRevealing);
        ...
        if (Botania.thaumcraftLoaded) addItem(ModItems.elementiumHelmRevealing);
        ...
        if (Botania.thaumcraftLoaded) addItem(ModItems.terrasteelHelmRevealing);
        ...
        if (ConfigHandler.stones18Enabled) {
            ...
            for (int i = 0; i < 8; i++) addBlock(ModFluffBlocks.stoneStairs[i]);
            for (int i = 0; i < 8; i++) addBlock(ModFluffBlocks.stoneSlabs[i]);
            addBlock(ModFluffBlocks.stoneWall);
        }

        addBlock(ModFluffBlocks.biomeStoneA);
        addBlock(ModFluffBlocks.biomeStoneB);
        for (int i = 0; i < 24; i++) addBlock(ModFluffBlocks.biomeStoneStairs[i]);
        for (int i = 0; i < 24; i++) addBlock(ModFluffBlocks.biomeStoneSlabs[i]);
        addBlock(ModFluffBlocks.biomeStoneWall);

        addBlock(ModFluffBlocks.pavement);
        for (Block pavementStair : ModFluffBlocks.pavementStairs) addBlock(pavementStair);
        for (Block pavementSlab : ModFluffBlocks.pavementSlabs) addBlock(pavementSlab);
