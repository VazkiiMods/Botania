 ...
 * 
 * File Created @ [Aug 24, 2015, 12:31:50 AM (CDT)]
 */
...
public class EntityShadowBeam extends EntityThrowable {
	...
	public void onUpdate() {
		...
		if (ticksExisted >= effectThreshhold)
			Botania.proxy.sparkleFX(worldObj, posX, posY, posZ, 0.3F, 0.09F, 1F, 4F, 1, true);
		...
		if (par1MovingObjectPosition != null) {
			if (par1MovingObjectPosition.entityHit == null) {
				...
				if (par1MovingObjectPosition.entityHit instanceof EntityLivingBase && !par1MovingObjectPosition.entityHit.equals(shooter))
					((EntityLivingBase)par1MovingObjectPosition.entityHit).attackEntityFrom(DamageSource.magic, 8F);
			}
		}
	}
