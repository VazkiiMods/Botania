...
public class EntityMagicMissile extends EntityThrowable {
    ...
    public void onUpdate() {
        ...
        for (int i = 0; i < steps; i++) {
            Botania.proxy.sparkleFX(
                    worldObj, particlePos.x, particlePos.y, particlePos.z, 1F, evil ? 0F : 0.4F, 1F, 0.8F, 2);
        ...
        if (target != null) {
            ...
            motionX = motionVec.x;
            motionY = motionVec.y;
            if (time < 10) motionY = Math.abs(motionY);
            motionZ = motionVec.z;
    ...
    public boolean getTarget() {
        ...
        List entities = worldObj.getEntitiesWithinAABB(
                isEvil() ? EntityPlayer.class : IMob.class,
                AxisAlignedBB.getBoundingBox(
    ...
    protected void onImpact(MovingObjectPosition pos) {
        ...
        if (!(block instanceof BlockBush)
                ...
                && (pos.entityHit == null || getTargetEntity() == pos.entityHit)) setDead();
    }
}
