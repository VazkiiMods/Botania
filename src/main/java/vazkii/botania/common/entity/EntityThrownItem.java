...
public class EntityThrownItem extends EntityItem {
    ...
    public EntityThrownItem(
            World p_i1710_1_, double p_i1710_2_, double p_i1710_4_, double p_i1710_6_, EntityItem item) {
    ...
    public void onUpdate() {
        ...
        if (!worldObj.isRemote) {
            ...
            List list = worldObj.getEntitiesWithinAABBExcludingEntity(
                    this,
                    boundingBox.addCoord(motionX * 2, motionY * 2, motionZ * 2).expand(2.0D, 2.0D, 2.0D));
            double d0 = 0.0D;
