...
public final class ModItems {
	...
	public static final Item manaSteel = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[0]);
	public static final Item manaPearl = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[1]);
	public static final Item manaDiamond = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[2]);
	public static final Item livingwoodTwig = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[3]);
	public static final Item terrasteel = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[4]);
	public static final Item lifeEssence = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[5]);
	public static final Item redstoneRoot = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[6]);
	public static final Item elementium = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[7]);
	public static final Item pixieDust = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[8]);
	public static final Item dragonstone = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[9]);
	public static final Item placeholder = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[11]);
	public static final Item redString = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[12]);
	public static final Item dreamwoodTwig = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[13]);
	public static final Item gaiaIngot = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[14]);
	public static final Item enderAirBottle = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[15]);
	public static final Item manaString = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[16]);
	public static final Item manasteelNugget = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[17]);
	public static final Item terrasteelNugget = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[18]);
	public static final Item elementiumNugget = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[19]);
	public static final Item livingroot = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[20]);
	public static final Item pebble = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[21]);
	public static final Item manaweaveCloth = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[22]);
	public static final Item manaPowder = new ItemManaResource().setRegistryName(LibMisc.MOD_ID, LibItemNames.MANA_RESOURCE_NAMES[23]);
