...
public class ItemIncenseStick extends ItemMod implements IBrewItem, IBrewContainer {
    ...
    public int getColorFromItemStack(ItemStack stack, int pass) {
        ...
        if (brew == BotaniaAPI.fallbackBrew) return 0x989898;
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean adv) {
        ...
        for (PotionEffect effect : brew.getPotionEffects(stack)) {
            ...
            PotionEffect longEffect = new PotionEffect(
                    effect.getPotionID(), effect.getDuration() * TIME_MULTIPLIER, effect.getAmplifier(), false);
            addStringToTooltip(
                    " " + format + StatCollector.translateToLocal(effect.getEffectName())
                            ...
                            + (potion.isInstant() ? "" : " (" + Potion.getDurationString(longEffect) + ")"),
                    list);
        }
    }
