...
public class ItemManasteelPick extends ItemPickaxe implements IManaUsingItem, ISortableTool {
    ...
    private static final Pattern TORCH_PATTERN =
            Pattern.compile("(?:(?:(?:[A-Z-_.:]|^)torch)|(?:(?:[a-z-_.:]|^)Torch))(?:[A-Z-_.:]|$)");
    ...
    public boolean onBlockDestroyed(
        ...
        if (block.getBlockHardness(world, x, y, z) != 0F) ToolCommons.damageItem(stack, 1, entity, getManaPerDmg());
