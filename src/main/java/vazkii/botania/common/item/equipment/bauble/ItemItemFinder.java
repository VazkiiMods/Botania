...
public class ItemItemFinder extends ItemBauble implements IBaubleRender {
    ...
    public void onWornTick(ItemStack stack, EntityLivingBase player) {
        ...
        if (player.worldObj.isRemote) tickClient(stack, (EntityPlayer) player);
        else tickServer(stack, (EntityPlayer) player);
    }

    public void tickClient(ItemStack stack, EntityPlayer player) {
        if (!Botania.proxy.isTheClientPlayer(player)) return;
        ...
        for (String token : tokens) {
            ...
            if (token.contains(",")) {
                ...
                Botania.proxy.wispFX(
                        ...
                        (float) Math.random(),
                        (float) Math.random(),
                        0.15F + 0.05F * (float) Math.random(),
                        m * (float) (Math.random() - 0.5),
                        m * (float) (Math.random() - 0.5),
                        m * (float) (Math.random() - 0.5));
            } else {
                ...
                if (e != null && Math.random() < 0.6) {
                    ...
                    Botania.proxy.wispFX(
                            player.worldObj,
                            e.posX + (float) (Math.random() * 0.5 - 0.25) * 0.45F,
                            e.posY + e.height,
                            e.posZ + (float) (Math.random() * 0.5 - 0.25) * 0.45F,
                            (float) Math.random(),
                            (float) Math.random(),
                            (float) Math.random(),
                            0.15F + 0.05F * (float) Math.random(),
                            -0.05F - 0.03F * (float) Math.random());
                }
            }
        }
            ...
            for (Entity e : entities) {
                ...
                if (e instanceof EntityItem) {
                    ...
                    if (player.isSneaking()
                            || istack.isItemEqual(pstack) && ItemStack.areItemStackTagsEqual(istack, pstack))
                    ...
                    AnimalChest chest =
                            ReflectionHelper.getPrivateValue(EntityHorse.class, horse, LibObfuscation.HORSE_CHEST);
                    ...
                    if (pstack != null && recipes != null)
                        for (MerchantRecipe recipe : recipes)
                            if (recipe != null
                                    ...
                                    && (equalStacks(pstack, recipe.getItemToBuy())
                                            || equalStacks(pstack, recipe.getItemToSell())))
    ...
    boolean scanInventory(IInventory inv, ItemStack pstack) {
        ...
        for (int l = 0; l < inv.getSizeInventory(); l++) {
            ...
            if (istack != null && equalStacks(istack, pstack)) return true;
        }
    ...
    public void onPlayerBaubleRender(ItemStack stack, RenderPlayerEvent event, RenderType type) {
        if (type == RenderType.HEAD) {
            ...
            ItemRenderer.renderItemIn2D(
                    Tessellator.instance, f1, f2, f, f3, gemIcon.getIconWidth(), gemIcon.getIconHeight(), 1F / 16F);
        }
    }
}
