    ...
    public void onPlayerBaubleRender(ItemStack stack, RenderPlayerEvent event, RenderType type) {
        if (type == RenderType.HEAD) {
            ...
            ItemRenderer.renderItemIn2D(
                    Tessellator.instance, f1, f2, f, f3, itemIcon.getIconWidth(), itemIcon.getIconHeight(), 1F / 16F);
        }
    }
    ...
    public static boolean hasMonocle(EntityPlayer player) {
        for (int i = 0; i < 4; i++) {
            ...
            if (stack != null) {
                ...
                if (item instanceof IBurstViewerBauble) return true;
                ...
                if (item instanceof ICosmeticAttachable) {
                    ...
                    if (cosmetic != null && cosmetic.getItem() instanceof IBurstViewerBauble) return true;
                }
            }
        }
