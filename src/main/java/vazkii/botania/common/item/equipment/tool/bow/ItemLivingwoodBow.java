...
public class ItemLivingwoodBow extends ItemBow implements IManaUsingItem {
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_) {
        ...
        if (flag) {
            ...
            if (!p_77615_2_.isRemote) p_77615_2_.spawnEntityInWorld(entityarrow);
        }
    }
    ...
    boolean canFire(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_) {
        return p_77615_3_.capabilities.isCreativeMode
                || EnchantmentHelper.getEnchantmentLevel(Enchantment.infinity.effectId, p_77615_1_) > 0
                || p_77615_3_.inventory.hasItem(Items.arrow);
    }

    void onFire(
            ItemStack p_77615_1_,
            World p_77615_2_,
            EntityPlayer p_77615_3_,
            int p_77615_4_,
            boolean infinity,
            EntityArrow arrow) {
        if (infinity) arrow.canBePickedUp = 2;
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < 3; i++) pullIcons[i] = IconHelper.forItem(par1IconRegister, this, i + 1);
    }
    ...
    public boolean getIsRepairable(ItemStack par1ItemStack, ItemStack par2ItemStack) {
        return par2ItemStack.getItem() == ModItems.manaResource && par2ItemStack.getItemDamage() == 3
                ? true
    ...
    public IIcon getIcon(ItemStack stack, int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining) {
        ...
        if (j >= 18) return pullIcons[2];
        if (j > 13) return pullIcons[1];
        if (j > 0) return pullIcons[0];
