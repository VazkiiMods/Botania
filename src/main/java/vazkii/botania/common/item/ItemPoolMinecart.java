        ...
        if (BlockRailBase.func_150051_a(p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_))) {
            if (!p_77648_3_.isRemote) {
                EntityMinecart entityminecart =
                        new EntityPoolMinecart(p_77648_3_, p_77648_4_ + 0.5, p_77648_5_ + 0.5, p_77648_6_ + 0.5);

                if (p_77648_1_.hasDisplayName()) entityminecart.setMinecartName(p_77648_1_.getDisplayName());
    ...
    public EntityMinecart placeCart(GameProfile owner, ItemStack cart, World world, int i, int j, int k) {
        if (BlockRailBase.func_150051_a(world.getBlock(i, j, k))) {
            if (!world.isRemote) {
                ...
                if (cart.hasDisplayName()) entityminecart.setMinecartName(cart.getDisplayName());

                if (world.spawnEntityInWorld(entityminecart)) return entityminecart;
            }
        }
        return null;
    }
