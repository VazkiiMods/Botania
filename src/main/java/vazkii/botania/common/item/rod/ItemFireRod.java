...
public class ItemFireRod extends ItemMod implements IManaUsingItem, IAvatarWieldable {
    ...
    public boolean onItemUse(
        ...
        if (!par3World.isRemote
                ...
                && ManaItemHandler.requestManaExactForTool(par1ItemStack, player, COST, false)) {
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
        if (par1ItemStack.isItemDamaged() && par3Entity instanceof EntityPlayer)
            par1ItemStack.setItemDamage(par1ItemStack.getItemDamage()
                    - (IManaProficiencyArmor.Helper.hasProficiency((EntityPlayer) par3Entity) ? 2 : 1));
    }
    ...
    public void onAvatarUpdate(IAvatarTile tile, ItemStack stack) {
        ...
        if (!world.isRemote
                && tile.getCurrentMana() >= COST
                && tile.getElapsedFunctionalTicks() % 300 == 0
                && tile.isEnabled()) {
