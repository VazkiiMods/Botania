...
public abstract class ItemRelicBauble extends ItemBauble implements IRelic {
    ...
    public void onUpdate(
        ...
        if (p_77663_3_ instanceof EntityPlayer) ItemRelic.updateRelic(p_77663_1_, (EntityPlayer) p_77663_3_);
    }
    ...
    public void onWornTick(ItemStack stack, EntityLivingBase player) {
        ...
        if (player instanceof EntityPlayer) {
            ...
            if (ItemRelic.isRightPlayer(ePlayer, stack)) onValidPlayerWornTick(stack, ePlayer);
        }
    }
