...
public class ItemFlugelEye extends ItemRelic implements ICoordBoundItem, IManaUsingItem {
    ...
    public ItemStack onEaten(ItemStack stack, World world, EntityPlayer player) {
        ...
        int cost = (int)
                (MathHelper.pointDistanceSpace(x + 0.5, y + 0.5, z + 0.5, player.posX, player.posY, player.posZ) * 10);
    ...
    private static void moveParticlesAndSound(Entity entity) {
        ...
        if (!entity.worldObj.isRemote) entity.worldObj.playSoundAtEntity(entity, "mob.endermen.portal", 1F, 1F);
    }
