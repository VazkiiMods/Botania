...
public class ItemKingKey extends ItemRelic implements IManaUsingItem {
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < WEAPON_TYPES; i++) weaponIcons[i] = IconHelper.forName(par1IconRegister, "gateWeapon" + i);
    }
    ...
    public void onUsingTick(ItemStack stack, EntityPlayer player, int count) {
        ...
        if (count != getMaxItemUseDuration(stack)
                ...
                && ManaItemHandler.requestManaExact(stack, player, 150, true)) {
            ...
            player.worldObj.playSoundAtEntity(
                    weapon, "botania:babylonSpawn", 1F, 1F + player.worldObj.rand.nextFloat() * 3F);
