...
public class ItemCraftPattern extends ItemMod {
    ...
    public boolean onItemUse(
            ItemStack stack, EntityPlayer p, World world, int x, int y, int z, int s, float xs, float ys, float zs) {
    ...
    public void getSubItems(Item item, CreativeTabs tab, List list) {
        for (int i = 0; i < TileCraftCrate.PATTERNS.length; i++) list.add(new ItemStack(item, 1, i));
    }
