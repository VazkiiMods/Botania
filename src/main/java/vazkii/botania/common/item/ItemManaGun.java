...
public class ItemManaGun extends ItemMod implements IManaUsingItem {
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        if (effect != null) effCd -= (effect.getAmplifier() + 1) * 8;
        ...
        if (par3EntityPlayer.isSneaking() && hasClip(par1ItemStack)) {
            ...
            par2World.playSoundAtEntity(
                    ...
                    "random.click",
                    0.6F,
                    (1.0F + (par2World.rand.nextFloat() - par2World.rand.nextFloat()) * 0.2F) * 0.7F);
            ...
            if (burst != null
                    && ManaItemHandler.requestManaExact(par1ItemStack, par3EntityPlayer, burst.getMana(), true)) {
                if (!par2World.isRemote) {
                    ...
                    if (isSugoiKawaiiDesuNe(par1ItemStack)) par3EntityPlayer.addStat(ModAchievements.desuGun, 1);
    ...
    public IIcon getIcon(ItemStack stack, int pass) {
        ...
        int index = pass;
        if (index == 0 && hasClip(stack)) index = 2;
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        ...
        if (clip) {
            ...
            for (int i = 0; i < CLIP_SLOTS; i++) {
                ...
                if (lensAt == null) name = StatCollector.translateToLocal("botaniamisc.clipEmpty");
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack) {
        ...
        return super.getItemStackDisplayName(par1ItemStack)
                + (lens == null
                        ? ""
                        : " (" + EnumChatFormatting.GREEN + lens.getDisplayName() + EnumChatFormatting.RESET + ")");
    }
    ...
    public static void rotatePos(ItemStack stack) {
        ...
        int index = 0;
        for (int i = currPos + 1; i < CLIP_SLOTS; i++, index++) slots[index] = i;
    ...
    public static void setLens(ItemStack stack, ItemStack lens) {
        if (hasClip(stack)) setLensAtPos(stack, lens, getClipPos(stack));
    ...
    public static ItemStack getLens(ItemStack stack) {
        if (hasClip(stack)) return getLensAtPos(stack, getClipPos(stack));
