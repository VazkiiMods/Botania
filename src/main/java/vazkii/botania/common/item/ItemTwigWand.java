...
public class ItemTwigWand extends Item16Colors implements ICoordBoundItem {
    ...
    public boolean onItemUse(
        ...
        if (boundTile.posY != -1
                ...
                && (boundTile.posX != par4 || boundTile.posY != par5 || boundTile.posZ != par6)) {
            ...
            if (tile instanceof IWandBindable) {
                if (((IWandBindable) tile).bindTo(par2EntityPlayer, par1ItemStack, par4, par5, par6, par7)) {
                    ...
                    VanillaPacketDispatcher.dispatchTEToNearbyPlayers(
                            par3World, boundTile.posX, boundTile.posY, boundTile.posZ);
        ...
        if (block == Blocks.lapis_block && ConfigHandler.enchanterEnabled) {
            ...
            if (getBindMode(par1ItemStack)
                    && bindable
                    && par2EntityPlayer.isSneaking()
                    && ((IWandBindable) tile).canSelect(par2EntityPlayer, par1ItemStack, par4, par5, par6, par7)) {
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
        ...
        if (tile == null || !(tile instanceof IWandBindable)) setBoundTile(par1ItemStack, 0, -1, 0);
    }
    ...
    public int getColorFromItemStack(ItemStack par1ItemStack, int par2) {
        if (par2 == 0 || par2 == 3) return 0xFFFFFF;
    ...
    public void getSubItems(Item par1, CreativeTabs par2CreativeTabs, List par3List) {
        for (int i = 0; i < 16; i++) par3List.add(forColors(i, i));
    }
