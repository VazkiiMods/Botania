...
public class ItemVineBall extends ItemMod {
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        par2World.playSoundAtEntity(
                par3EntityPlayer, "random.bow", 0.5F, 0.4F / (par2World.rand.nextFloat() * 0.4F + 0.8F));

        if (!par2World.isRemote) par2World.spawnEntityInWorld(new EntityVineBall(par3EntityPlayer, true));
