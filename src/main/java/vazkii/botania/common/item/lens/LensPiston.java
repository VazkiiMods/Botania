    ...
    public boolean collideBurst(
        ...
        if ((coords.posX != pos.blockX || coords.posY != pos.blockY || coords.posZ != pos.blockZ)
            ...
            if (entity.worldObj.isAirBlock(x, y, z)
                    || entity.worldObj.getBlock(x, y, z).isReplaceable(entity.worldObj, x, y, z)) {
                ...
                if (block.getMobilityFlag() == 0
                        && block != Blocks.obsidian
                        && block.getBlockHardness(entity.worldObj, pos.blockX, pos.blockY, pos.blockZ) >= 0
                        && tile == null) {
                    entity.worldObj.setBlockToAir(pos.blockX, pos.blockY, pos.blockZ);
                    entity.worldObj.setBlock(x, y, z, block, meta, 1 | 2);
                    entity.worldObj.playAuxSFX(
                            2001, pos.blockX, pos.blockY, pos.blockZ, Block.getIdFromBlock(block) + (meta << 12));
                }
            }
        }
