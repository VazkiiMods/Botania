...
public class LensFire extends Lens {
    ...
    public boolean collideBurst(
        ...
        if ((coords.posX != pos.blockX || coords.posY != pos.blockY || coords.posZ != pos.blockZ)
            ...
            if (blockAt == Blocks.portal) entity.worldObj.setBlock(pos.blockX, pos.blockY, pos.blockZ, Blocks.air);
            else if (blockAt == ModBlocks.incensePlate) {
                TileIncensePlate plate =
                        (TileIncensePlate) entity.worldObj.getTileEntity(pos.blockX, pos.blockY, pos.blockZ);
                plate.ignite();
            } else if (blockAt_.isAir(entity.worldObj, x, y, z)) entity.worldObj.setBlock(x, y, z, Blocks.fire);
        }
