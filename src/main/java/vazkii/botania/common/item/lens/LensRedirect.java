...
public class LensRedirect extends Lens {
    ...
    public boolean collideBurst(
        ...
        if (!entity.worldObj.isRemote
                && pos.entityHit == null
                && coords.posY != -1
                && (pos.blockX != coords.posX || pos.blockY != coords.posY || pos.blockZ != coords.posZ)) {
            ...
            if (tile != null && tile instanceof IRedirectable) {
                if (!burst.isFake()) {
                    ...
                    AxisAlignedBB axis = entity.worldObj
                            .getBlock(coords.posX, coords.posY, coords.posZ)
                            .getCollisionBoundingBoxFromPool(entity.worldObj, coords.posX, coords.posY, coords.posZ);
                    if (axis == null)
                        axis = AxisAlignedBB.getBoundingBox(
                                coords.posX,
                                coords.posY,
                                coords.posZ,
                                coords.posX + 1,
