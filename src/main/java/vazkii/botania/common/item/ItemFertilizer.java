    ...
    public boolean onItemUse(
        ...
        if (!par3World.isRemote) {
                ...
                for (int j = -range - 1; j < range; j++) {
                    for (int k = 2; k >= -2; k--) {
                        ...
                        if (par3World.isAirBlock(x, y, z)
                                && (!par3World.provider.hasNoSky || y < 255)
                                && ModBlocks.flower.canBlockStay(par3World, x, y, z))
            ...
            for (int i = 0; i < flowerCount; i++) {
                ...
                par3World.setBlock(
                        coords.posX, coords.posY, coords.posZ, ModBlocks.flower, par3World.rand.nextInt(16), 1 | 2);
            }
