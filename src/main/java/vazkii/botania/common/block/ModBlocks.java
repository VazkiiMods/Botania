...
public final class ModBlocks {
	public static final Block whiteFlower = new BlockModFlower(DyeColor.WHITE, Block.Properties.of(Material.PLANT).noCollision().strength(0).sounds(BlockSoundGroup.GRASS));
	public static final Block orangeFlower = new BlockModFlower(DyeColor.ORANGE, Block.Properties.copy(whiteFlower));
	public static final Block magentaFlower = new BlockModFlower(DyeColor.MAGENTA, Block.Properties.copy(whiteFlower));
	public static final Block lightBlueFlower = new BlockModFlower(DyeColor.LIGHT_BLUE, Block.Properties.copy(whiteFlower));
	public static final Block yellowFlower = new BlockModFlower(DyeColor.YELLOW, Block.Properties.copy(whiteFlower));
	public static final Block limeFlower = new BlockModFlower(DyeColor.LIME, Block.Properties.copy(whiteFlower));
	public static final Block pinkFlower = new BlockModFlower(DyeColor.PINK, Block.Properties.copy(whiteFlower));
	public static final Block grayFlower = new BlockModFlower(DyeColor.GRAY, Block.Properties.copy(whiteFlower));
	public static final Block lightGrayFlower = new BlockModFlower(DyeColor.LIGHT_GRAY, Block.Properties.copy(whiteFlower));
	public static final Block cyanFlower = new BlockModFlower(DyeColor.CYAN, Block.Properties.copy(whiteFlower));
	public static final Block purpleFlower = new BlockModFlower(DyeColor.PURPLE, Block.Properties.copy(whiteFlower));
	public static final Block blueFlower = new BlockModFlower(DyeColor.BLUE, Block.Properties.copy(whiteFlower));
	public static final Block brownFlower = new BlockModFlower(DyeColor.BROWN, Block.Properties.copy(whiteFlower));
	public static final Block greenFlower = new BlockModFlower(DyeColor.GREEN, Block.Properties.copy(whiteFlower));
	public static final Block redFlower = new BlockModFlower(DyeColor.RED, Block.Properties.copy(whiteFlower));
	public static final Block blackFlower = new BlockModFlower(DyeColor.BLACK, Block.Properties.copy(whiteFlower));

	public static final Block defaultAltar = new BlockAltar(BlockAltar.Variant.DEFAULT, Block.Properties.of(Material.STONE).strength(3.5F).sounds(BlockSoundGroup.STONE)
			.lightLevel(s -> s.get(BlockAltar.FLUID) == IPetalApothecary.State.LAVA ? 15 : 0));
	public static final Block forestAltar = new BlockAltar(BlockAltar.Variant.FOREST, Block.Properties.copy(defaultAltar));
	public static final Block plainsAltar = new BlockAltar(BlockAltar.Variant.PLAINS, Block.Properties.copy(defaultAltar));
	public static final Block mountainAltar = new BlockAltar(BlockAltar.Variant.MOUNTAIN, Block.Properties.copy(defaultAltar));
	public static final Block fungalAltar = new BlockAltar(BlockAltar.Variant.FUNGAL, Block.Properties.copy(defaultAltar));
	public static final Block swampAltar = new BlockAltar(BlockAltar.Variant.SWAMP, Block.Properties.copy(defaultAltar));
	public static final Block desertAltar = new BlockAltar(BlockAltar.Variant.DESERT, Block.Properties.copy(defaultAltar));
	public static final Block taigaAltar = new BlockAltar(BlockAltar.Variant.TAIGA, Block.Properties.copy(defaultAltar));
	public static final Block mesaAltar = new BlockAltar(BlockAltar.Variant.MESA, Block.Properties.copy(defaultAltar));
	public static final Block mossyAltar = new BlockAltar(BlockAltar.Variant.MOSSY, Block.Properties.copy(defaultAltar));

	public static final Block livingrock = new BlockMod(Block.Properties.of(Material.STONE).strength(2, 10).sounds(BlockSoundGroup.STONE));
	public static final Block livingrockBrick = new BlockMod(Block.Properties.copy(livingrock));
	public static final Block livingrockBrickChiseled = new BlockMod(Block.Properties.copy(livingrock));
	public static final Block livingrockBrickCracked = new BlockMod(Block.Properties.copy(livingrock));
	public static final Block livingrockBrickMossy = new BlockMod(Block.Properties.copy(livingrock));

	public static final Block livingwood = new BlockMod(Block.Properties.of(Material.WOOD).strength(2).sounds(BlockSoundGroup.WOOD));
	public static final Block livingwoodPlanks = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block livingwoodPlanksMossy = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block livingwoodFramed = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block livingwoodPatternFramed = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block livingwoodGlimmering = new BlockMod(Block.Properties.copy(livingwood).lightLevel(s -> 12));

	private static final AbstractBlock.TypedContextPredicate<EntityType<?>> NO_SPAWN = (state, world, pos, et) -> false;
	public static final Block manaSpreader = new BlockSpreader(BlockSpreader.Variant.MANA, Block.Properties.copy(livingwood).allowsSpawning(NO_SPAWN));
	public static final Block redstoneSpreader = new BlockSpreader(BlockSpreader.Variant.REDSTONE, Block.Properties.copy(livingwood).allowsSpawning(NO_SPAWN));
	public static final Block elvenSpreader = new BlockSpreader(BlockSpreader.Variant.ELVEN, Block.Properties.copy(livingwood).allowsSpawning(NO_SPAWN));
	public static final Block gaiaSpreader = new BlockSpreader(BlockSpreader.Variant.GAIA, Block.Properties.copy(livingwood).allowsSpawning(NO_SPAWN));

	public static final Block manaPool = new BlockPool(BlockPool.Variant.DEFAULT, Block.Properties.copy(livingrock));
	public static final Block creativePool = new BlockPool(BlockPool.Variant.CREATIVE, Block.Properties.copy(livingrock));
	public static final Block dilutedPool = new BlockPool(BlockPool.Variant.DILUTED, Block.Properties.copy(livingrock));
	public static final Block fabulousPool = new BlockPool(BlockPool.Variant.FABULOUS, Block.Properties.copy(livingrock));

	public static final Block runeAltar = new BlockRuneAltar(Block.Properties.copy(livingrock));
	public static final Block manaPylon = new BlockPylon(BlockPylon.Variant.MANA, Block.Properties.of(Material.METAL).strength(5.5F).sounds(BlockSoundGroup.METAL).lightLevel(s -> 7));
	public static final Block naturaPylon = new BlockPylon(BlockPylon.Variant.NATURA, Block.Properties.copy(manaPylon));
	public static final Block gaiaPylon = new BlockPylon(BlockPylon.Variant.GAIA, Block.Properties.copy(manaPylon));

	public static final Block pistonRelay = new BlockPistonRelay(Block.Properties.of(Material.GOURD).strength(2, 10).sounds(BlockSoundGroup.METAL).allowsSpawning(NO_SPAWN));
	public static final Block distributor = new BlockDistributor(Block.Properties.of(Material.STONE).strength(2, 10).sounds(BlockSoundGroup.STONE));
	public static final Block manaVoid = new BlockManaVoid(Block.Properties.of(Material.STONE).strength(2, 2000).sounds(BlockSoundGroup.STONE));
	public static final Block manaDetector = new BlockManaDetector(Block.Properties.copy(livingrock));
	public static final Block enchanter = new BlockEnchanter(Block.Properties.of(Material.STONE).strength(3, 5).lightLevel(s -> 15).sounds(BlockSoundGroup.STONE));
	public static final Block turntable = new BlockTurntable(Block.Properties.copy(livingwood));
	public static final Block tinyPlanet = new BlockTinyPlanet(Block.Properties.of(Material.STONE).strength(20, 100).sounds(BlockSoundGroup.STONE));
	public static final Block alchemyCatalyst = new BlockAlchemyCatalyst(Block.Properties.copy(livingrock));
	public static final Block openCrate = new BlockOpenCrate(Block.Properties.copy(livingwood));
	public static final Block craftCrate = new BlockCraftyCrate(Block.Properties.copy(livingwood));
	public static final Block forestEye = new BlockForestEye(Block.Properties.of(Material.METAL).strength(5, 10).sounds(BlockSoundGroup.METAL));
	public static final Block manasteelBlock = new BlockMod(Block.Properties.of(Material.METAL).strength(3, 10).sounds(BlockSoundGroup.METAL));
	public static final Block terrasteelBlock = new BlockMod(Block.Properties.copy(manasteelBlock));
	public static final Block elementiumBlock = new BlockMod(Block.Properties.copy(manasteelBlock));
	public static final Block manaDiamondBlock = new BlockMod(Block.Properties.copy(manasteelBlock));
	public static final Block dragonstoneBlock = new BlockMod(Block.Properties.copy(manasteelBlock));
	public static final Block wildDrum = new BlockForestDrum(BlockForestDrum.Variant.WILD, Block.Properties.copy(livingwood));
	public static final Block gatheringDrum = new BlockForestDrum(BlockForestDrum.Variant.GATHERING, Block.Properties.copy(livingwood));
	public static final Block canopyDrum = new BlockForestDrum(BlockForestDrum.Variant.CANOPY, Block.Properties.copy(livingwood));

	public static final Block whiteShinyFlower = new BlockShinyFlower(DyeColor.WHITE, Block.Properties.copy(whiteFlower).lightLevel(s -> 15));
	public static final Block orangeShinyFlower = new BlockShinyFlower(DyeColor.ORANGE, Block.Properties.copy(whiteShinyFlower));
	public static final Block magentaShinyFlower = new BlockShinyFlower(DyeColor.MAGENTA, Block.Properties.copy(whiteShinyFlower));
	public static final Block lightBlueShinyFlower = new BlockShinyFlower(DyeColor.LIGHT_BLUE, Block.Properties.copy(whiteShinyFlower));
	public static final Block yellowShinyFlower = new BlockShinyFlower(DyeColor.YELLOW, Block.Properties.copy(whiteShinyFlower));
	public static final Block limeShinyFlower = new BlockShinyFlower(DyeColor.LIME, Block.Properties.copy(whiteShinyFlower));
	public static final Block pinkShinyFlower = new BlockShinyFlower(DyeColor.PINK, Block.Properties.copy(whiteShinyFlower));
	public static final Block grayShinyFlower = new BlockShinyFlower(DyeColor.GRAY, Block.Properties.copy(whiteShinyFlower));
	public static final Block lightGrayShinyFlower = new BlockShinyFlower(DyeColor.LIGHT_GRAY, Block.Properties.copy(whiteShinyFlower));
	public static final Block cyanShinyFlower = new BlockShinyFlower(DyeColor.CYAN, Block.Properties.copy(whiteShinyFlower));
	public static final Block purpleShinyFlower = new BlockShinyFlower(DyeColor.PURPLE, Block.Properties.copy(whiteShinyFlower));
	public static final Block blueShinyFlower = new BlockShinyFlower(DyeColor.BLUE, Block.Properties.copy(whiteShinyFlower));
	public static final Block brownShinyFlower = new BlockShinyFlower(DyeColor.BROWN, Block.Properties.copy(whiteShinyFlower));
	public static final Block greenShinyFlower = new BlockShinyFlower(DyeColor.GREEN, Block.Properties.copy(whiteShinyFlower));
	public static final Block redShinyFlower = new BlockShinyFlower(DyeColor.RED, Block.Properties.copy(whiteShinyFlower));
	public static final Block blackShinyFlower = new BlockShinyFlower(DyeColor.BLACK, Block.Properties.copy(whiteShinyFlower));

	public static final Block abstrusePlatform = new BlockPlatform(BlockPlatform.Variant.ABSTRUSE, Block.Properties.of(Material.WOOD).strength(2, 5).sounds(BlockSoundGroup.WOOD));
	public static final Block spectralPlatform = new BlockPlatform(BlockPlatform.Variant.SPECTRAL, Block.Properties.copy(abstrusePlatform));
	public static final Block infrangiblePlatform = new BlockPlatform(BlockPlatform.Variant.INFRANGIBLE, Block.Properties.of(Material.WOOD).strength(-1, Float.MAX_VALUE).sounds(BlockSoundGroup.WOOD));
	public static final Block alfPortal = new BlockAlfPortal(Block.Properties.of(Material.WOOD).strength(10).sounds(BlockSoundGroup.WOOD)
			.lightLevel(s -> s.get(BotaniaStateProps.ALFPORTAL_STATE) != AlfPortalState.OFF ? 15 : 0));
	public static final Block dreamwood = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block dreamwoodPlanks = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block dreamwoodPlanksMossy = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block dreamwoodFramed = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block dreamwoodPatternFramed = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block dreamwoodGlimmering = new BlockMod(Block.Properties.copy(livingwoodGlimmering));
	public static final Block conjurationCatalyst = new BlockConjurationCatalyst(Block.Properties.copy(livingrock));
	public static final Block bifrost = new BlockBifrost(Block.Properties.of(Material.GLASS).strength(-1, 0.3F).lightLevel(s -> 15).sounds(BlockSoundGroup.GLASS).nonOpaque());
	public static final Block solidVines = new BlockSolidVines(Block.Properties.of(Material.REPLACEABLE_PLANT).strength(0.2F).sounds(BlockSoundGroup.GRASS).nonOpaque());

	public static final Block whiteBuriedPetals = new BlockBuriedPetals(DyeColor.WHITE, Block.Properties.copy(whiteFlower).lightLevel(s -> 4));
	public static final Block orangeBuriedPetals = new BlockBuriedPetals(DyeColor.ORANGE, Block.Properties.copy(whiteBuriedPetals));
	public static final Block magentaBuriedPetals = new BlockBuriedPetals(DyeColor.MAGENTA, Block.Properties.copy(whiteBuriedPetals));
	public static final Block lightBlueBuriedPetals = new BlockBuriedPetals(DyeColor.LIGHT_BLUE, Block.Properties.copy(whiteBuriedPetals));
	public static final Block yellowBuriedPetals = new BlockBuriedPetals(DyeColor.YELLOW, Block.Properties.copy(whiteBuriedPetals));
	public static final Block limeBuriedPetals = new BlockBuriedPetals(DyeColor.LIME, Block.Properties.copy(whiteBuriedPetals));
	public static final Block pinkBuriedPetals = new BlockBuriedPetals(DyeColor.PINK, Block.Properties.copy(whiteBuriedPetals));
	public static final Block grayBuriedPetals = new BlockBuriedPetals(DyeColor.GRAY, Block.Properties.copy(whiteBuriedPetals));
	public static final Block lightGrayBuriedPetals = new BlockBuriedPetals(DyeColor.LIGHT_GRAY, Block.Properties.copy(whiteBuriedPetals));
	public static final Block cyanBuriedPetals = new BlockBuriedPetals(DyeColor.CYAN, Block.Properties.copy(whiteBuriedPetals));
	public static final Block purpleBuriedPetals = new BlockBuriedPetals(DyeColor.PURPLE, Block.Properties.copy(whiteBuriedPetals));
	public static final Block blueBuriedPetals = new BlockBuriedPetals(DyeColor.BLUE, Block.Properties.copy(whiteBuriedPetals));
	public static final Block brownBuriedPetals = new BlockBuriedPetals(DyeColor.BROWN, Block.Properties.copy(whiteBuriedPetals));
	public static final Block greenBuriedPetals = new BlockBuriedPetals(DyeColor.GREEN, Block.Properties.copy(whiteBuriedPetals));
	public static final Block redBuriedPetals = new BlockBuriedPetals(DyeColor.RED, Block.Properties.copy(whiteBuriedPetals));
	public static final Block blackBuriedPetals = new BlockBuriedPetals(DyeColor.BLACK, Block.Properties.copy(whiteBuriedPetals));

	public static final Block whiteFloatingFlower = new BlockFloatingFlower(DyeColor.WHITE, Block.Properties.of(Material.SOIL).strength(0.5F).sounds(BlockSoundGroup.GRAVEL).lightLevel(s -> 15));
	public static final Block orangeFloatingFlower = new BlockFloatingFlower(DyeColor.ORANGE, Block.Properties.copy(whiteFloatingFlower));
	public static final Block magentaFloatingFlower = new BlockFloatingFlower(DyeColor.MAGENTA, Block.Properties.copy(whiteFloatingFlower));
	public static final Block lightBlueFloatingFlower = new BlockFloatingFlower(DyeColor.LIGHT_BLUE, Block.Properties.copy(whiteFloatingFlower));
	public static final Block yellowFloatingFlower = new BlockFloatingFlower(DyeColor.YELLOW, Block.Properties.copy(whiteFloatingFlower));
	public static final Block limeFloatingFlower = new BlockFloatingFlower(DyeColor.LIME, Block.Properties.copy(whiteFloatingFlower));
	public static final Block pinkFloatingFlower = new BlockFloatingFlower(DyeColor.PINK, Block.Properties.copy(whiteFloatingFlower));
	public static final Block grayFloatingFlower = new BlockFloatingFlower(DyeColor.GRAY, Block.Properties.copy(whiteFloatingFlower));
	public static final Block lightGrayFloatingFlower = new BlockFloatingFlower(DyeColor.LIGHT_GRAY, Block.Properties.copy(whiteFloatingFlower));
	public static final Block cyanFloatingFlower = new BlockFloatingFlower(DyeColor.CYAN, Block.Properties.copy(whiteFloatingFlower));
	public static final Block purpleFloatingFlower = new BlockFloatingFlower(DyeColor.PURPLE, Block.Properties.copy(whiteFloatingFlower));
	public static final Block blueFloatingFlower = new BlockFloatingFlower(DyeColor.BLUE, Block.Properties.copy(whiteFloatingFlower));
	public static final Block brownFloatingFlower = new BlockFloatingFlower(DyeColor.BROWN, Block.Properties.copy(whiteFloatingFlower));
	public static final Block greenFloatingFlower = new BlockFloatingFlower(DyeColor.GREEN, Block.Properties.copy(whiteFloatingFlower));
	public static final Block redFloatingFlower = new BlockFloatingFlower(DyeColor.RED, Block.Properties.copy(whiteFloatingFlower));
	public static final Block blackFloatingFlower = new BlockFloatingFlower(DyeColor.BLACK, Block.Properties.copy(whiteFloatingFlower));

	public static final Block tinyPotato = new BlockTinyPotato(Block.Properties.of(Material.WOOL).strength(0.25F));
	public static final Block spawnerClaw = new BlockSpawnerClaw(Block.Properties.of(Material.METAL).strength(3));

	public static final Block azulejo0 = new BlockMod(Block.Properties.of(Material.STONE).strength(2, 5).sounds(BlockSoundGroup.STONE));
	public static final Block azulejo1 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo2 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo3 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo4 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo5 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo6 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo7 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo8 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo9 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo10 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo11 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo12 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo13 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo14 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block azulejo15 = new BlockMod(Block.Properties.copy(azulejo0));
	public static final Block enderEye = new BlockEnderEye(Block.Properties.copy(manasteelBlock));
	public static final Block starfield = new BlockStarfield(Block.Properties.of(Material.METAL).strength(5, 2000).sounds(BlockSoundGroup.METAL));
	public static final Block rfGenerator = new BlockRFGenerator(Block.Properties.copy(livingrock));
	public static final Block elfGlass = new BlockModGlass(Block.Properties.copy(Blocks.GLASS).lightLevel(s -> 15));
	public static final Block brewery = new BlockBrewery(Block.Properties.copy(livingrock));
	public static final Block manaGlass = new BlockModGlass(Block.Properties.copy(elfGlass));
	public static final Block terraPlate = new BlockTerraPlate(Block.Properties.of(Material.METAL).strength(3, 10).sounds(BlockSoundGroup.METAL));
	public static final Block redStringContainer = new BlockRedStringContainer(Block.Properties.copy(livingrock));
	public static final Block redStringDispenser = new BlockRedStringDispenser(Block.Properties.copy(livingrock));
	public static final Block redStringFertilizer = new BlockRedStringFertilizer(Block.Properties.copy(livingrock));
	public static final Block redStringComparator = new BlockRedStringComparator(Block.Properties.copy(livingrock));
	public static final Block redStringRelay = new BlockRedStringRelay(Block.Properties.copy(livingrock));
	public static final Block redStringInterceptor = new BlockRedStringInterceptor(Block.Properties.copy(livingrock));
	public static final Block manaFlame = new BlockManaFlame(Block.Properties.of(Material.WOOL).sounds(BlockSoundGroup.WOOL).lightLevel(s -> 15).noCollision());
	public static final Block prism = new BlockPrism(Block.Properties.copy(elfGlass).noCollision());
	public static final Block enchantedSoil = new BlockEnchantedSoil(Block.Properties.of(Material.SOLID_ORGANIC).strength(0.6F).sounds(BlockSoundGroup.GRASS));

	public static final Block petalBlockWhite = new BlockPetalBlock(DyeColor.WHITE, Block.Properties.of(Material.PLANT).strength(0.4F).sounds(BlockSoundGroup.GRASS));
	public static final Block petalBlockOrange = new BlockPetalBlock(DyeColor.ORANGE, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockMagenta = new BlockPetalBlock(DyeColor.MAGENTA, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockLightBlue = new BlockPetalBlock(DyeColor.LIGHT_BLUE, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockYellow = new BlockPetalBlock(DyeColor.YELLOW, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockLime = new BlockPetalBlock(DyeColor.LIME, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockPink = new BlockPetalBlock(DyeColor.PINK, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockGray = new BlockPetalBlock(DyeColor.GRAY, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockSilver = new BlockPetalBlock(DyeColor.LIGHT_GRAY, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockCyan = new BlockPetalBlock(DyeColor.CYAN, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockPurple = new BlockPetalBlock(DyeColor.PURPLE, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockBlue = new BlockPetalBlock(DyeColor.BLUE, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockBrown = new BlockPetalBlock(DyeColor.BROWN, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockGreen = new BlockPetalBlock(DyeColor.GREEN, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockRed = new BlockPetalBlock(DyeColor.RED, Block.Properties.copy(petalBlockWhite));
	public static final Block petalBlockBlack = new BlockPetalBlock(DyeColor.BLACK, Block.Properties.copy(petalBlockWhite));

	public static final Block corporeaIndex = new BlockCorporeaIndex(Block.Properties.of(Material.METAL).strength(5.5F).sounds(BlockSoundGroup.METAL).nonOpaque());
	public static final Block corporeaFunnel = new BlockCorporeaFunnel(Block.Properties.of(Material.METAL).strength(5.5F).sounds(BlockSoundGroup.METAL));

	public static final Block whiteMushroom = new BlockModMushroom(DyeColor.WHITE, Block.Properties.copy(whiteFlower).lightLevel(s -> 3));
	public static final Block orangeMushroom = new BlockModMushroom(DyeColor.ORANGE, Block.Properties.copy(whiteMushroom));
	public static final Block magentaMushroom = new BlockModMushroom(DyeColor.MAGENTA, Block.Properties.copy(whiteMushroom));
	public static final Block lightBlueMushroom = new BlockModMushroom(DyeColor.LIGHT_BLUE, Block.Properties.copy(whiteMushroom));
	public static final Block yellowMushroom = new BlockModMushroom(DyeColor.YELLOW, Block.Properties.copy(whiteMushroom));
	public static final Block limeMushroom = new BlockModMushroom(DyeColor.LIME, Block.Properties.copy(whiteMushroom));
	public static final Block pinkMushroom = new BlockModMushroom(DyeColor.PINK, Block.Properties.copy(whiteMushroom));
	public static final Block grayMushroom = new BlockModMushroom(DyeColor.GRAY, Block.Properties.copy(whiteMushroom));
	public static final Block lightGrayMushroom = new BlockModMushroom(DyeColor.LIGHT_GRAY, Block.Properties.copy(whiteMushroom));
	public static final Block cyanMushroom = new BlockModMushroom(DyeColor.CYAN, Block.Properties.copy(whiteMushroom));
	public static final Block purpleMushroom = new BlockModMushroom(DyeColor.PURPLE, Block.Properties.copy(whiteMushroom));
	public static final Block blueMushroom = new BlockModMushroom(DyeColor.BLUE, Block.Properties.copy(whiteMushroom));
	public static final Block brownMushroom = new BlockModMushroom(DyeColor.BROWN, Block.Properties.copy(whiteMushroom));
	public static final Block greenMushroom = new BlockModMushroom(DyeColor.GREEN, Block.Properties.copy(whiteMushroom));
	public static final Block redMushroom = new BlockModMushroom(DyeColor.RED, Block.Properties.copy(whiteMushroom));
	public static final Block blackMushroom = new BlockModMushroom(DyeColor.BLACK, Block.Properties.copy(whiteMushroom));

	public static final Block pump = new BlockPump(Block.Properties.copy(livingrock));

	public static final Block doubleFlowerWhite = new BlockModDoubleFlower(DyeColor.WHITE, Block.Properties.copy(whiteFlower));
	public static final Block doubleFlowerOrange = new BlockModDoubleFlower(DyeColor.ORANGE, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerMagenta = new BlockModDoubleFlower(DyeColor.MAGENTA, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerLightBlue = new BlockModDoubleFlower(DyeColor.LIGHT_BLUE, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerYellow = new BlockModDoubleFlower(DyeColor.YELLOW, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerLime = new BlockModDoubleFlower(DyeColor.LIME, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerPink = new BlockModDoubleFlower(DyeColor.PINK, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerGray = new BlockModDoubleFlower(DyeColor.GRAY, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerLightGray = new BlockModDoubleFlower(DyeColor.LIGHT_GRAY, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerCyan = new BlockModDoubleFlower(DyeColor.CYAN, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerPurple = new BlockModDoubleFlower(DyeColor.PURPLE, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerBlue = new BlockModDoubleFlower(DyeColor.BLUE, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerBrown = new BlockModDoubleFlower(DyeColor.BROWN, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerGreen = new BlockModDoubleFlower(DyeColor.GREEN, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerRed = new BlockModDoubleFlower(DyeColor.RED, Block.Properties.copy(doubleFlowerWhite));
	public static final Block doubleFlowerBlack = new BlockModDoubleFlower(DyeColor.BLACK, Block.Properties.copy(doubleFlowerWhite));

	public static final Block fakeAir = new BlockFakeAir(Block.Properties.of(Material.STRUCTURE_VOID).ticksRandomly());
	public static final Block blazeBlock = new BlockMod(Block.Properties.copy(manasteelBlock).lightLevel(s -> 15));
	public static final Block corporeaInterceptor = new BlockCorporeaInterceptor(Block.Properties.of(Material.METAL).strength(5.5F).sounds(BlockSoundGroup.METAL));
	public static final Block corporeaCrystalCube = new BlockCorporeaCrystalCube(Block.Properties.copy(corporeaInterceptor));
	public static final Block incensePlate = new BlockIncensePlate(Block.Properties.copy(livingwood));
	public static final Block hourglass = new BlockHourglass(Block.Properties.of(Material.METAL).strength(2).sounds(BlockSoundGroup.METAL));
	public static final Block ghostRail = new BlockGhostRail(Block.Properties.copy(Blocks.RAIL));
	public static final Block sparkChanger = new BlockSparkChanger(Block.Properties.copy(livingrock));
	public static final Block root = new BlockRoot(Block.Properties.of(Material.PLANT).strength(1.2F).sounds(BlockSoundGroup.WOOD));
	public static final Block felPumpkin = new BlockFelPumpkin(Block.Properties.copy(Blocks.CARVED_PUMPKIN));
	public static final Block cocoon = new BlockCocoon(Block.Properties.of(Material.WOOL).strength(3, 60).sounds(BlockSoundGroup.WOOL));
	public static final Block lightRelayDefault = new BlockLightRelay(LuminizerVariant.DEFAULT, Block.Properties.of(Material.GLASS).noCollision());
	public static final Block lightRelayDetector = new BlockLightRelay(LuminizerVariant.DETECTOR, Block.Properties.copy(lightRelayDefault));
	public static final Block lightRelayFork = new BlockLightRelay(LuminizerVariant.TOGGLE, Block.Properties.copy(lightRelayDefault));
	public static final Block lightRelayToggle = new BlockLightRelay(LuminizerVariant.FORK, Block.Properties.copy(lightRelayDefault));
	public static final Block lightLauncher = new BlockLightLauncher(Block.Properties.copy(livingwood));
	public static final Block manaBomb = new BlockManaBomb(Block.Properties.of(Material.WOOD).strength(12).sounds(BlockSoundGroup.WOOD));
	public static final Block cacophonium = new BlockCacophonium(Block.Properties.of(Material.WOOD).strength(0.8F));
	public static final Block bellows = new BlockBellows(Block.Properties.copy(livingwood));
	public static final Block bifrostPerm = new BlockBifrostPerm(Block.Properties.of(Material.GLASS).strength(0.3F).lightLevel(s -> 15).sounds(BlockSoundGroup.GLASS).nonOpaque());
	public static final Block cellBlock = new BlockCell(Block.Properties.of(Material.GOURD).sounds(BlockSoundGroup.WOOL));
	public static final Block gaiaHeadWall = new BlockGaiaHeadWall(Block.Properties.of(Material.SUPPORTED).strength(1));
	public static final Block gaiaHead = new BlockGaiaHead(Block.Properties.of(Material.SUPPORTED).strength(1));
	public static final Block corporeaRetainer = new BlockCorporeaRetainer(Block.Properties.copy(corporeaInterceptor));
	public static final Block teruTeruBozu = new BlockTeruTeruBozu(Block.Properties.of(Material.WOOL));
	public static final Block shimmerrock = new BlockMod(Block.Properties.copy(livingrock));
	public static final Block shimmerwoodPlanks = new BlockMod(Block.Properties.copy(livingwood));
	public static final Block avatar = new BlockAvatar(Block.Properties.copy(livingwood));
	public static final Block dryGrass = new BlockAltGrass(BlockAltGrass.Variant.DRY, Block.Properties.of(Material.SOLID_ORGANIC).strength(0.6F).ticksRandomly().sounds(BlockSoundGroup.GRASS));
	public static final Block goldenGrass = new BlockAltGrass(BlockAltGrass.Variant.GOLDEN, Block.Properties.copy(dryGrass));
	public static final Block vividGrass = new BlockAltGrass(BlockAltGrass.Variant.VIVID, Block.Properties.copy(dryGrass));
	public static final Block scorchedGrass = new BlockAltGrass(BlockAltGrass.Variant.SCORCHED, Block.Properties.copy(dryGrass));
	public static final Block infusedGrass = new BlockAltGrass(BlockAltGrass.Variant.INFUSED, Block.Properties.copy(dryGrass));
