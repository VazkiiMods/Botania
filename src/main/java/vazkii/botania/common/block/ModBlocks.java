...
public final class ModBlocks {
	...
	public static final AbstractBlock.Properties FLOATING_PROPS = Block.Properties.create(Material.EARTH).hardnessAndResistance(0.5F).sound(SoundType.GROUND).setLightLevel(s -> 15).harvestTool(ToolType.SHOVEL);
	...
	public static final Block abstrusePlatform = new BlockPlatform(BlockPlatform.Variant.ABSTRUSE, Block.Properties.create(Material.WOOD).hardnessAndResistance(2, 5).sound(SoundType.WOOD).notSolid().variableOpacity());
	...
	public static final Block infrangiblePlatform = new BlockPlatform(BlockPlatform.Variant.INFRANGIBLE, Block.Properties.create(Material.WOOD).hardnessAndResistance(-1, Float.MAX_VALUE).sound(SoundType.WOOD).notSolid().variableOpacity());
	...
	public static final Block fakeAir = new BlockFakeAir(Block.Properties.create(Material.STRUCTURE_VOID).setAir().tickRandomly());
	...
	public static final Block dryGrass = new BlockAltGrass(BlockAltGrass.Variant.DRY, Block.Properties.create(Material.ORGANIC).hardnessAndResistance(0.6F).tickRandomly().sound(SoundType.PLANT).harvestTool(ToolType.SHOVEL));
