...
public final class ModBlocks {
	...
	public static final Block whiteFloatingFlower = new BlockFloatingFlower(DyeColor.WHITE, AbstractBlock.Settings.of(Material.SOIL).strength(0.5F).sounds(BlockSoundGroup.GRAVEL).lightLevel(s -> 15));
	public static final Block orangeFloatingFlower = new BlockFloatingFlower(DyeColor.ORANGE, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block magentaFloatingFlower = new BlockFloatingFlower(DyeColor.MAGENTA, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block lightBlueFloatingFlower = new BlockFloatingFlower(DyeColor.LIGHT_BLUE, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block yellowFloatingFlower = new BlockFloatingFlower(DyeColor.YELLOW, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block limeFloatingFlower = new BlockFloatingFlower(DyeColor.LIME, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block pinkFloatingFlower = new BlockFloatingFlower(DyeColor.PINK, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block grayFloatingFlower = new BlockFloatingFlower(DyeColor.GRAY, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block lightGrayFloatingFlower = new BlockFloatingFlower(DyeColor.LIGHT_GRAY, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block cyanFloatingFlower = new BlockFloatingFlower(DyeColor.CYAN, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block purpleFloatingFlower = new BlockFloatingFlower(DyeColor.PURPLE, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block blueFloatingFlower = new BlockFloatingFlower(DyeColor.BLUE, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block brownFloatingFlower = new BlockFloatingFlower(DyeColor.BROWN, AbstractBlock.Settings.copy(whiteFloatingFlower));
	public static final Block greenFloatingFlower = new BlockFloatingFlower(DyeColor.GREEN, AbstractBlock.Settings.copy(whiteFloatingFlower));
