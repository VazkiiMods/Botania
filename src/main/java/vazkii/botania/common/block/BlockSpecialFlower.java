...
public class BlockSpecialFlower extends BlockFlower
        implements ITileEntityProvider, ISpecialFlower, IWandable, ILexiconable, IWandHUD {
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        for (String s : BotaniaAPI.getAllSubTiles())
            if (!s.isEmpty()) BotaniaAPI.getSignatureForName(s).registerIcons(par1IconRegister);
    }
    ...
    public void onBlockHarvested(
        ...
        if (!par6EntityPlayer.capabilities.isCreativeMode) {
            ...
            ((TileSpecialFlower) par1World.getTileEntity(par2, par3, par4))
                    .onBlockHarvested(par1World, par2, par3, par4, par5, par6EntityPlayer);
        }
    }
    ...
    public boolean onBlockActivated(
        ...
        if (stack != null && stack.getItem() == ModItems.dye) {
            ...
            if (newMeta != oldMeta) world.setBlockMetadataWithNotify(x, y, z, newMeta, 1 | 2);
        }

        return ((TileSpecialFlower) world.getTileEntity(x, y, z))
