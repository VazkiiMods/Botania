...
public abstract class BlockCorporeaBaseWaterloggable extends BlockCorporeaBase implements Waterloggable {

	public BlockCorporeaBaseWaterloggable(Settings builder) {
		super(builder);
