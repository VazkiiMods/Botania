...
public class TileIncensePlate extends TileSimpleInventory implements ISidedInventory {
    ...
    public void updateEntity() {
                ...
                if (!worldObj.isRemote) {
                    ...
                    for (EntityPlayer player : players) {
                        PotionEffect currentEffect =
                                player.getActivePotionEffect(Potion.potionTypes[effect.getPotionID()]);
                        ...
                        if (currentEffect == null || currentEffect.getDuration() < (nightVision ? 205 : 3)) {
                            PotionEffect applyEffect = new PotionEffect(
                                    effect.getPotionID(), nightVision ? 285 : 80, effect.getAmplifier(), true);
                    ...
                    Botania.proxy.wispFX(
                            ...
                            g,
                            b,
                            0.05F + (float) Math.random() * 0.02F,
                            0.005F - (float) Math.random() * 0.01F,
                            0.01F + (float) Math.random() * 0.005F,
                            0.005F - (float) Math.random() * 0.01F);
                    Botania.proxy.wispFX(
                            worldObj,
                            x - (Math.random() - 0.5) * 0.2,
                            ...
                            0.05F + (float) Math.random() * 0.02F,
                            0.005F - (float) Math.random() * 0.01F,
                            0.01F + (float) Math.random() * 0.001F,
                            0.005F - (float) Math.random() * 0.01F);
                }
            } else {
        ...
        int newComparator = 0;
        if (stack != null) newComparator = 1;
        if (burning) newComparator = 2;
    ...
    public boolean isItemValidForSlot(int i, ItemStack itemstack) {
        return itemstack != null
                && itemstack.getItem() == ModItems.incenseStick
                && ((ItemIncenseStick) ModItems.incenseStick).getBrew(itemstack) != BotaniaAPI.fallbackBrew;
    }
    ...
    public void markDirty() {
        super.markDirty();
        if (!worldObj.isRemote) VanillaPacketDispatcher.dispatchTEToNearbyPlayers(this);
    }
}
