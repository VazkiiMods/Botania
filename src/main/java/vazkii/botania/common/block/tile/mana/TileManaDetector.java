...
public class TileManaDetector extends TileMod implements IManaCollisionGhost {
    ...
    public void updateEntity() {
        if (!worldObj.isRemote) {
            ...
            int expectedMeta = worldObj.getEntitiesWithinAABB(
                                            IManaBurst.class,
                    ...
                    ? 1
                    : 0;
            if (meta != expectedMeta) worldObj.setBlockMetadataWithNotify(xCoord, yCoord, zCoord, expectedMeta, 1 | 2);
