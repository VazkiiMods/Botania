...
public final class ModFluffBlocks {
	public static final Block livingwoodStairs = new BlockModStairs(livingwood.getDefaultState(), Block.Properties.copy(livingwood));
	public static final Block livingwoodSlab = new SlabBlock(Block.Properties.copy(livingwood));
	public static final Block livingwoodWall = new WallBlock(Block.Properties.copy(livingwood));
	public static final Block livingwoodFence = new FenceBlock(Block.Properties.copy(livingwood));
	public static final Block livingwoodFenceGate = new FenceGateBlock(Block.Properties.copy(livingwood));
	public static final Block livingwoodPlankStairs = new BlockModStairs(livingwoodPlanks.getDefaultState(), Block.Properties.copy(livingwoodPlanks));
	public static final Block livingwoodPlankSlab = new SlabBlock(Block.Properties.copy(livingwoodPlanks));
	public static final Block livingrockStairs = new BlockModStairs(livingrock.getDefaultState(), Block.Properties.copy(livingrock));
	public static final Block livingrockSlab = new SlabBlock(Block.Properties.copy(livingrock));
	public static final Block livingrockWall = new WallBlock(Block.Properties.copy(livingrock));
	public static final Block livingrockBrickStairs = new BlockModStairs(livingrockBrick.getDefaultState(), Block.Properties.copy(livingrockBrick));
	public static final Block livingrockBrickSlab = new SlabBlock(Block.Properties.copy(livingrockBrick));
	public static final Block dreamwoodStairs = new BlockModStairs(dreamwood.getDefaultState(), Block.Properties.copy(dreamwood));
	public static final Block dreamwoodSlab = new SlabBlock(Block.Properties.copy(dreamwood));
	public static final Block dreamwoodWall = new WallBlock(Block.Properties.copy(dreamwood));
	public static final Block dreamwoodFence = new FenceBlock(Block.Properties.copy(dreamwood));
	public static final Block dreamwoodFenceGate = new FenceGateBlock(Block.Properties.copy(dreamwood));
	public static final Block dreamwoodPlankStairs = new BlockModStairs(dreamwoodPlanks.getDefaultState(), Block.Properties.copy(dreamwoodPlanks));
	public static final Block dreamwoodPlankSlab = new SlabBlock(Block.Properties.copy(dreamwoodPlanks));

	public static final Block darkQuartz = new BlockMod(Block.Properties.copy(Blocks.QUARTZ_BLOCK));
	public static final Block darkQuartzChiseled = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block darkQuartzPillar = new PillarBlock(Block.Properties.copy(darkQuartz));
	public static final Block darkQuartzSlab = new SlabBlock(Block.Properties.copy(darkQuartz));
	public static final Block darkQuartzStairs = new BlockModStairs(darkQuartz.getDefaultState(), Block.Properties.copy(darkQuartz));

	public static final Block manaQuartz = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block manaQuartzChiseled = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block manaQuartzPillar = new PillarBlock(Block.Properties.copy(darkQuartz));
	public static final Block manaQuartzSlab = new SlabBlock(Block.Properties.copy(darkQuartz));
	public static final Block manaQuartzStairs = new BlockModStairs(darkQuartz.getDefaultState(), Block.Properties.copy(darkQuartz));

	public static final Block blazeQuartz = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block blazeQuartzChiseled = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block blazeQuartzPillar = new PillarBlock(Block.Properties.copy(darkQuartz));
	public static final Block blazeQuartzSlab = new SlabBlock(Block.Properties.copy(darkQuartz));
	public static final Block blazeQuartzStairs = new BlockModStairs(darkQuartz.getDefaultState(), Block.Properties.copy(darkQuartz));

	public static final Block lavenderQuartz = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block lavenderQuartzChiseled = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block lavenderQuartzPillar = new PillarBlock(Block.Properties.copy(darkQuartz));
	public static final Block lavenderQuartzSlab = new SlabBlock(Block.Properties.copy(darkQuartz));
	public static final Block lavenderQuartzStairs = new BlockModStairs(darkQuartz.getDefaultState(), Block.Properties.copy(darkQuartz));

	public static final Block redQuartz = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block redQuartzChiseled = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block redQuartzPillar = new PillarBlock(Block.Properties.copy(darkQuartz));
	public static final Block redQuartzSlab = new SlabBlock(Block.Properties.copy(darkQuartz));
	public static final Block redQuartzStairs = new BlockModStairs(darkQuartz.getDefaultState(), Block.Properties.copy(darkQuartz));

	public static final Block elfQuartz = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block elfQuartzChiseled = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block elfQuartzPillar = new PillarBlock(Block.Properties.copy(darkQuartz));
	public static final Block elfQuartzSlab = new SlabBlock(Block.Properties.copy(darkQuartz));
	public static final Block elfQuartzStairs = new BlockModStairs(darkQuartz.getDefaultState(), Block.Properties.copy(darkQuartz));

	public static final Block sunnyQuartz = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block sunnyQuartzChiseled = new BlockMod(Block.Properties.copy(darkQuartz));
	public static final Block sunnyQuartzPillar = new PillarBlock(Block.Properties.copy(darkQuartz));
	public static final Block sunnyQuartzSlab = new SlabBlock(Block.Properties.copy(darkQuartz));
	public static final Block sunnyQuartzStairs = new BlockModStairs(darkQuartz.getDefaultState(), Block.Properties.copy(darkQuartz));

	public static final Block whitePavement = new BlockMod(Block.Properties.copy(livingrock));
	public static final Block whitePavementStair = new BlockModStairs(whitePavement.getDefaultState(), Block.Properties.copy(whitePavement));
	public static final Block whitePavementSlab = new SlabBlock(Block.Properties.copy(whitePavement));

	public static final Block blackPavement = new BlockMod(Block.Properties.copy(whitePavement));
	public static final Block blackPavementStair = new BlockModStairs(whitePavement.getDefaultState(), Block.Properties.copy(whitePavement));
	public static final Block blackPavementSlab = new SlabBlock(Block.Properties.copy(whitePavement));

	public static final Block bluePavement = new BlockMod(Block.Properties.copy(whitePavement));
	public static final Block bluePavementStair = new BlockModStairs(whitePavement.getDefaultState(), Block.Properties.copy(whitePavement));
	public static final Block bluePavementSlab = new SlabBlock(Block.Properties.copy(whitePavement));

	public static final Block yellowPavement = new BlockMod(Block.Properties.copy(whitePavement));
	public static final Block yellowPavementStair = new BlockModStairs(whitePavement.getDefaultState(), Block.Properties.copy(whitePavement));
	public static final Block yellowPavementSlab = new SlabBlock(Block.Properties.copy(whitePavement));

	public static final Block redPavement = new BlockMod(Block.Properties.copy(whitePavement));
	public static final Block redPavementStair = new BlockModStairs(whitePavement.getDefaultState(), Block.Properties.copy(whitePavement));
	public static final Block redPavementSlab = new SlabBlock(Block.Properties.copy(whitePavement));

	public static final Block greenPavement = new BlockMod(Block.Properties.copy(whitePavement));
	public static final Block greenPavementStair = new BlockModStairs(whitePavement.getDefaultState(), Block.Properties.copy(whitePavement));
	public static final Block greenPavementSlab = new SlabBlock(Block.Properties.copy(whitePavement));

	public static final Block biomeStoneForest = new BlockMod(Block.Properties.of(Material.STONE).strength(1.5F, 10).sounds(BlockSoundGroup.STONE));
	public static final Block biomeStoneForestSlab = new SlabBlock(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStoneForestStairs = new BlockModStairs(biomeStoneForest.getDefaultState(), Block.Properties.copy(biomeStoneForest));
	public static final Block biomeCobblestoneForest = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeCobblestoneForestSlab = new SlabBlock(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeCobblestoneForestStairs = new BlockModStairs(biomeStoneForest.getDefaultState(), Block.Properties.copy(biomeStoneForest));
	public static final Block biomeWallForest = new WallBlock(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeBrickForest = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeBrickForestSlab = new SlabBlock(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeBrickForestStairs = new BlockModStairs(biomeStoneForest.getDefaultState(), Block.Properties.copy(biomeStoneForest));
	public static final Block biomeChiseledBrickForest = new BlockMod(Block.Properties.copy(biomeStoneForest));

	public static final Block biomeStonePlains = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStonePlainsSlab = new SlabBlock(Block.Properties.copy(biomeStonePlains));
	public static final Block biomeStonePlainsStairs = new BlockModStairs(biomeStonePlains.getDefaultState(), Block.Properties.copy(biomeStonePlains));
	public static final Block biomeCobblestonePlains = new BlockMod(Block.Properties.copy(biomeStonePlains));
	public static final Block biomeCobblestonePlainsSlab = new SlabBlock(Block.Properties.copy(biomeStonePlains));
	public static final Block biomeCobblestonePlainsStairs = new BlockModStairs(biomeStonePlains.getDefaultState(), Block.Properties.copy(biomeStonePlains));
	public static final Block biomeWallPlains = new WallBlock(Block.Properties.copy(biomeStonePlains));
	public static final Block biomeBrickPlains = new BlockMod(Block.Properties.copy(biomeStonePlains));
	public static final Block biomeBrickPlainsSlab = new SlabBlock(Block.Properties.copy(biomeStonePlains));
	public static final Block biomeBrickPlainsStairs = new BlockModStairs(biomeStonePlains.getDefaultState(), Block.Properties.copy(biomeStonePlains));
	public static final Block biomeChiseledBrickPlains = new BlockMod(Block.Properties.copy(biomeStonePlains));

	public static final Block biomeStoneMountain = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStoneMountainSlab = new SlabBlock(Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeStoneMountainStairs = new BlockModStairs(biomeStoneMountain.getDefaultState(), Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeCobblestoneMountain = new BlockMod(Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeCobblestoneMountainSlab = new SlabBlock(Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeCobblestoneMountainStairs = new BlockModStairs(biomeStoneMountain.getDefaultState(), Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeWallMountain = new WallBlock(Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeBrickMountain = new BlockMod(Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeBrickMountainSlab = new SlabBlock(Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeBrickMountainStairs = new BlockModStairs(biomeStoneMountain.getDefaultState(), Block.Properties.copy(biomeStoneMountain));
	public static final Block biomeChiseledBrickMountain = new BlockMod(Block.Properties.copy(biomeStoneMountain));

	public static final Block biomeStoneFungal = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStoneFungalSlab = new SlabBlock(Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeStoneFungalStairs = new BlockModStairs(biomeStoneFungal.getDefaultState(), Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeCobblestoneFungal = new BlockMod(Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeCobblestoneFungalSlab = new SlabBlock(Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeCobblestoneFungalStairs = new BlockModStairs(biomeStoneFungal.getDefaultState(), Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeWallFungal = new WallBlock(Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeBrickFungal = new BlockMod(Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeBrickFungalSlab = new SlabBlock(Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeBrickFungalStairs = new BlockModStairs(biomeStoneFungal.getDefaultState(), Block.Properties.copy(biomeStoneFungal));
	public static final Block biomeChiseledBrickFungal = new BlockMod(Block.Properties.copy(biomeStoneFungal));

	public static final Block biomeStoneSwamp = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStoneSwampSlab = new SlabBlock(Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeStoneSwampStairs = new BlockModStairs(biomeStoneSwamp.getDefaultState(), Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeCobblestoneSwamp = new BlockMod(Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeCobblestoneSwampSlab = new SlabBlock(Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeCobblestoneSwampStairs = new BlockModStairs(biomeStoneSwamp.getDefaultState(), Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeWallSwamp = new WallBlock(Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeBrickSwamp = new BlockMod(Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeBrickSwampSlab = new SlabBlock(Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeBrickSwampStairs = new BlockModStairs(biomeStoneSwamp.getDefaultState(), Block.Properties.copy(biomeStoneSwamp));
	public static final Block biomeChiseledBrickSwamp = new BlockMod(Block.Properties.copy(biomeStoneSwamp));

	public static final Block biomeStoneDesert = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStoneDesertSlab = new SlabBlock(Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeStoneDesertStairs = new BlockModStairs(biomeStoneDesert.getDefaultState(), Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeCobblestoneDesert = new BlockMod(Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeCobblestoneDesertSlab = new SlabBlock(Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeCobblestoneDesertStairs = new BlockModStairs(biomeStoneDesert.getDefaultState(), Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeWallDesert = new WallBlock(Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeBrickDesert = new BlockMod(Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeBrickDesertSlab = new SlabBlock(Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeBrickDesertStairs = new BlockModStairs(biomeStoneDesert.getDefaultState(), Block.Properties.copy(biomeStoneDesert));
	public static final Block biomeChiseledBrickDesert = new BlockMod(Block.Properties.copy(biomeStoneDesert));

	public static final Block biomeStoneTaiga = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStoneTaigaSlab = new SlabBlock(Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeStoneTaigaStairs = new BlockModStairs(biomeStoneTaiga.getDefaultState(), Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeCobblestoneTaiga = new BlockMod(Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeCobblestoneTaigaSlab = new SlabBlock(Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeCobblestoneTaigaStairs = new BlockModStairs(biomeStoneTaiga.getDefaultState(), Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeWallTaiga = new WallBlock(Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeBrickTaiga = new BlockMod(Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeBrickTaigaSlab = new SlabBlock(Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeBrickTaigaStairs = new BlockModStairs(biomeStoneTaiga.getDefaultState(), Block.Properties.copy(biomeStoneTaiga));
	public static final Block biomeChiseledBrickTaiga = new BlockMod(Block.Properties.copy(biomeStoneTaiga));

	public static final Block biomeStoneMesa = new BlockMod(Block.Properties.copy(biomeStoneForest));
	public static final Block biomeStoneMesaSlab = new SlabBlock(Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeStoneMesaStairs = new BlockModStairs(biomeStoneMesa.getDefaultState(), Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeCobblestoneMesa = new BlockMod(Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeCobblestoneMesaSlab = new SlabBlock(Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeCobblestoneMesaStairs = new BlockModStairs(biomeStoneMesa.getDefaultState(), Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeWallMesa = new WallBlock(Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeBrickMesa = new BlockMod(Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeBrickMesaSlab = new SlabBlock(Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeBrickMesaStairs = new BlockModStairs(biomeStoneMesa.getDefaultState(), Block.Properties.copy(biomeStoneMesa));
	public static final Block biomeChiseledBrickMesa = new BlockMod(Block.Properties.copy(biomeStoneMesa));

	public static final Block shimmerrockSlab = new SlabBlock(Block.Properties.copy(shimmerrock));
	public static final Block shimmerrockStairs = new BlockModStairs(shimmerrock.getDefaultState(), Block.Properties.copy(shimmerrock));

	public static final Block shimmerwoodPlankSlab = new SlabBlock(Block.Properties.copy(shimmerwoodPlanks));
	public static final Block shimmerwoodPlankStairs = new BlockModStairs(shimmerwoodPlanks.getDefaultState(), Block.Properties.copy(shimmerwoodPlanks));

	public static final Block managlassPane = new BlockModPane(Block.Properties.copy(manaGlass));
