...
public class BlockModDoubleFlower extends BlockDoublePlant implements ILexiconable {
    ...
    public IIcon func_149888_a(boolean top, int index) {
        return (ConfigHandler.altFlowerTextures
                        ? top ? doublePlantTopIconsAlt : doublePlantBottomIconsAlt
                        : top ? doublePlantTopIcons : doublePlantBottomIcons)
                [index & 7];
    }

    @Override
    public void func_149889_c(
            World p_149889_1_, int p_149889_2_, int p_149889_3_, int p_149889_4_, int p_149889_5_, int p_149889_6_) {
    ...
    public void harvestBlockCopy(
        ...
        if (this.canSilkHarvest(p_149636_1_, p_149636_2_, p_149636_3_, p_149636_4_, p_149636_5_, p_149636_6_)
            ...
            ForgeEventFactory.fireBlockHarvesting(
                    ...
                    true,
                    p_149636_2_);
            for (ItemStack is : items) this.dropBlockAsItem(p_149636_1_, p_149636_3_, p_149636_4_, p_149636_5_, is);
        } else {
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
        ...
        if (top) meta = world.getBlockMetadata(x, y - 1, z);

        return (ConfigHandler.altFlowerTextures
                        ? top ? doublePlantBottomIconsAlt : doublePlantTopIconsAlt
                        : top ? doublePlantBottomIcons : doublePlantTopIcons)
                [meta & 7];
    }
    ...
    public void registerBlockIcons(IIconRegister register) {
        ...
        for (int i = 0; i < COUNT; i++) {
            ...
            doublePlantBottomIconsAlt[i] =
                    IconHelper.forName(register, "flower" + off + "Tall1", BlockModFlower.ALT_DIR);
        }
    }
    ...
    public void getSubBlocks(Item p_149666_1_, CreativeTabs p_149666_2_, List p_149666_3_) {
        for (int i = 0; i < COUNT; ++i) p_149666_3_.add(new ItemStack(p_149666_1_, 1, i));
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (par5Random.nextDouble() < ConfigHandler.flowerParticleFrequency)
            Botania.proxy.sparkleFX(
                    par1World,
                    par2 + 0.3 + par5Random.nextFloat() * 0.5,
                    par3 + 0.5 + par5Random.nextFloat() * 0.5,
                    par4 + 0.3 + par5Random.nextFloat() * 0.5,
                    color[0],
                    color[1],
                    color[2],
