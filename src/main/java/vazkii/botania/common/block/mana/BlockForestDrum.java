...
public class BlockForestDrum extends BlockMod implements IManaTrigger, ILexiconable {
    ...
    public IIcon getIcon(int side, int meta) {
        ...
        boolean tree = meta == 2;
        return side < 2
                ? animal ? iconBasesA : tree ? iconBasesB : iconBases
                : animal ? iconFacesA : tree ? iconFacesB : iconFaces;
    }
    ...
    public void onBurstCollision(IManaBurst burst, World world, int x, int y, int z) {
        ...
        if (world.getBlockMetadata(x, y, z) == 0) ItemGrassHorn.breakGrass(world, null, 0, x, y, z);
        else if (world.getBlockMetadata(x, y, z) == 2) ItemGrassHorn.breakGrass(world, null, 1, x, y, z);
            ...
            for (EntityLiving entity : entities) {
                if (entity instanceof IShearable
                        && ((IShearable) entity)
                                .isShearable(stack, world, (int) entity.posX, (int) entity.posY, (int) entity.posZ)) {
            ...
            for (EntityLiving entity : shearables) {
                ...
                List<ItemStack> stacks = ((IShearable) entity)
                        .onSheared(stack, world, (int) entity.posX, (int) entity.posY, (int) entity.posZ, 0);
                if (stacks != null)
        ...
        if (!world.isRemote) for (int i = 0; i < 10; i++) world.playSoundEffect(x, y, z, "note.bd", 1F, 1F);
