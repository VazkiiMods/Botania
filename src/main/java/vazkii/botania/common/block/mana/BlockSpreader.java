...
public class BlockSpreader extends BlockModContainer
    ...
    public void getSubBlocks(Item par1, CreativeTabs par2, List par3) {
        for (int i = 0; i < 4; i++) par3.add(new ItemStack(par1, 1, i));
    }
    ...
    public LexiconEntry getEntry(World world, int x, int y, int z, EntityPlayer player, ItemStack lexicon) {
        ...
        return meta == 0
                ? LexiconData.spreader
                : meta == 1 ? LexiconData.redstoneSpreader : LexiconData.dreamwoodSpreader;
    }
