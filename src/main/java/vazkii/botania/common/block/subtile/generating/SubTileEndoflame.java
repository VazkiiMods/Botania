            ...
            if (burnTime == 0) {
                if (mana < getMaxMana()) {
                    ...
                    for (EntityItem item : items) {
                        if (item.age >= (59 + slowdown) && !item.isDead) {
                            ...
                            int burnTime = stack == null || stack.getItem() == Item.getItemFromBlock(ModBlocks.spreader)
                                    ? 0
                            ...
                            if (burnTime > 0 && stack.stackSize > 0) {
                                ...
                                if (!supertile.getWorldObj().isRemote) {
                                    ...
                                    item.worldObj.spawnParticle(
                                            "largesmoke", item.posX, item.posY + 0.1, item.posZ, 0.0D, 0.0D, 0.0D);
                                    item.worldObj.spawnParticle(
                                            "flame", item.posX, item.posY, item.posZ, 0.0D, 0.0D, 0.0D);
                                }
                ...
                if (supertile.getWorldObj().rand.nextInt(10) == 0)
                    supertile
                            ...
                            .spawnParticle(
                                    "flame",
                                    supertile.xCoord + 0.4 + Math.random() * 0.2,
                                    supertile.yCoord + 0.65,
                                    supertile.zCoord + 0.4 + Math.random() * 0.2,
                                    0.0D,
                                    0.0D,
                                    0.0D);
