...
public class SubTileOrechid extends SubTileFunctional {
    ...
    public void onUpdate() {
        ...
        if (redstoneSignal > 0 || !canOperate()) return;
            ...
            if (coords != null) {
                ...
                if (stack != null) {
                    ...
                    supertile
                            .getWorldObj()
                            .playSoundEffect(
                                    supertile.xCoord, supertile.yCoord, supertile.zCoord, "botania:orechid", 2F, 1F);
    ...
    public ItemStack getOreToPut() {
        ...
        for (String s : map.keySet()) values.add(new StringRandomItem(map.get(s), s));
