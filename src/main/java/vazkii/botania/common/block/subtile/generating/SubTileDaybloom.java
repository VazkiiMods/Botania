...
public class SubTileDaybloom extends SubTilePassiveGenerating {
    ...
    public boolean canGeneratePassively() {
        ...
        return supertile.getWorldObj().isDaytime()
                && !rain
                && supertile.getWorldObj().canBlockSeeTheSky(supertile.xCoord, supertile.yCoord + 1, supertile.zCoord);
    }
