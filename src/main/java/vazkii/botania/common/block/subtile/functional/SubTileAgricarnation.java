...
public class SubTileAgricarnation extends SubTileFunctional {
                    ...
                    if (ConfigHandler.blockBreakParticles)
                        supertile
                                ...
                                .playAuxSFX(
                                        ...
                                        y,
                                        z,
                                        6 + supertile.getWorldObj().rand.nextInt(4));
                    supertile
                            .getWorldObj()
                            .playSoundEffect(
                                    x, y, z, "botania:agricarnation", 0.01F, 0.5F + (float) Math.random() * 0.5F);
    ...
    boolean isPlant(int x, int y, int z) {
        ...
        return mat != null
                ...
                && ((IGrowable) block)
                        .func_149851_a(supertile.getWorldObj(), x, y, z, supertile.getWorldObj().isRemote);
    }
