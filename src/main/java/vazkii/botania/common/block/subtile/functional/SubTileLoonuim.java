    ...
    public void onUpdate() {
        ...
        if (redstoneSignal == 0 && ticksExisted % 200 == 0 && mana >= COST) {
            ...
            EntityItem entity = new EntityItem(
                    ...
                    supertile.xCoord - RANGE + rand.nextInt(bound),
                    supertile.yCoord + 1,
                    supertile.zCoord - RANGE + rand.nextInt(bound),
                    stack);
            entity.motionX = 0;
            entity.motionY = 0;
            entity.motionZ = 0;

            if (!supertile.getWorldObj().isRemote) supertile.getWorldObj().spawnEntityInWorld(entity);
