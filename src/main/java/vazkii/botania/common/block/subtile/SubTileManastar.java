...
public class SubTileManastar extends SubTileEntity {
    ...
    public void onUpdate() {
        ...
        for (ForgeDirection dir : LibMisc.CARDINAL_DIRECTIONS) {
            TileEntity tile = supertile
                    .getWorldObj()
                    .getTileEntity(supertile.xCoord + dir.offsetX, supertile.yCoord, supertile.zCoord + dir.offsetZ);
            if (tile instanceof IManaPool) mana += ((IManaPool) tile).getCurrentMana();
        }
        ...
        if (manaLastTick != -1 && mana != manaLastTick && Math.random() > 0.6) {
            ...
            Botania.proxy.wispFX(
                    ...
                    supertile.yCoord + 0.75 + Math.random() * 0.2 - 0.1,
        ...
        if (ticksExisted % 60 == 0) manaLastTick = mana;
    }
