...
public class BergamuteEventHandler {
    ...
    public void onSoundEvent(PlaySoundEvent evt) {
        ...
        if (sound != null && shouldSilence(sound.getCategory())) {
            ...
            if (berg != null) {
                ...
                if (RAND.nextBoolean()) {
                    Color color = new Color(berg.getColor());
    ...
    private static class WrappedSound implements ISound {
        ...
        @Nullable @Override public SoundEventAccessor createAccessor(SoundHandler handler) { return compose.createAccessor(handler); }
        @Nonnull @Override public Sound getSound() {
