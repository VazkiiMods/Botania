...
public final class ModBanners {
    ...
    public static void init() {
        try {
            Class<Enum<?>> clazz = (Class<Enum<?>>)
                    Class.forName("ganymedes01.etfuturum.tileentities.TileEntityBanner$EnumBannerPattern");
    ...
    public static void addPattern(Class<Enum<?>> clazz, String name, String id, ItemStack craftingItem) {
        ...
        id = "bt_" + id;
        EnumHelper.addEnum(
                clazz, name.toUpperCase(), new Class[] {String.class, String.class, ItemStack.class}, new Object[] {
