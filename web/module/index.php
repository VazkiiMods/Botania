...
<div class="featurettes">
	...
	<div class="row featurette">
		...
		<div class="col-md-7">
			...
			<span class="glyphicon glyphicon-ok"></span> Refrain from showing numbers to the player to minimize the incentive to minmax;<br>
			...
			<a class="btn btn-lg btn-material-lightgreen" href="./downloads.php" role="button">Download Botania</a>
			</p>
		</div>
	</div>
</div>
