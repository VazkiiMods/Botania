...
*   Artists and other Asset Providers (listed in alphabetic order):
    ...
    *   **Lorc** of [game-icons.net](https://game-icons.net/) for the icons that were formerly used in the main lexicon page.
...
*   Notable Technical Contributors:
    ...
    *   **jaredlll08** for hosting Maven and Jenkins for all the Violet Moon mods, and teaching the maintainers about Multiloader development
