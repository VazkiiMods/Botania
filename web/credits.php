	...
	<body>
		...
		<div class="container">
			<div class="content">
				...
				<b>Flaxbeard</b> for the Rod of the Black Meas, and for texture work when dylan isn't available.<br>
		...
		<script> $(function() { $('#header-btn-credits').addClass('active'); }); </script>
