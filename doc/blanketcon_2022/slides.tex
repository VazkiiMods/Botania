...
\begin{frame}{Downcalls To Platform}
  \begin{center}
    \begin{tikzpicture}[node distance=1.2cm]
      ...
      \node (ixplat) [std, below of=xplat] {\texttt{IXplatAbstractions}};
      \node (forge) [std, below = of ixplat] {\texttt{ModList::isLoaded()}};
      \node (fabric) [std, right = of forge] {\texttt{FabricLoader::isModLoaded}};
