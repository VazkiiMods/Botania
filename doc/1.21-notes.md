...
* [x] Crafty Crate is dead, long live the Crafter! — ~~Do we repurpose crafting placeholders and patterns for use with the Crafter or do we remove them as well?~~ We don't.
  ...
  * [x] Potential replacement: A dreamwood version of the open crate that can point in any direction instead of only down.
  * [ ] Datafixer replacement for Crafty Crate could be either a vanilla crafter that is pointing down and has the same slot configuration, or the open dreamwood crate.
  * [ ] Figure out an alternative way to auto-activate a vanilla crafter under similar conditions as the Crafty Crate. (Maybe wand held by livingwood avatar? But would it also activate other things that make sense? Maybe just tag blocks that avatars can interact with this way.)
...
* [ ] Complete more block sets:
  * [ ] extend the shimmerwood planks and shimmerrock blocksets to include other usual block types, like fences and walls, respectively
  * [ ] signs, hanging signs, doors, trapdoors (livingwood, dreamwood, shimmerwood)
    * [ ] Need icons for signs and hanging signs
    * [ ] Need textures for doors and trapdoors
  * [ ] buttons and pressure plates for Botania's planks and stone types (livingwood, dreamwood, shimmerwood, livingrock, shimmerrock, corporea, biome stones; same behavior as other woods and stones, although maybe the corporea pressure plate only detects player entities?)
...
* [ ] Mana infusion catalyst rebalance
  * [ ] Make sapling cycle more expensive (similar to crop cycle; it's presumably a one-time investment anyway)
  * [ ] Merge tuff and calcite into granite/andesite/diorite cycle (deepslate can be obtained from purifying endstone)
  * [ ] Maybe a Nether stones cycle? (blackstone and basalt)
    * [ ] Could include netherrack as an alternate way to obtain that from basalt generation
  * [ ] Add bamboo support
  ...
  * [ ] Make amethyst available
    ...
    * [ ] Some way to make amethyst clusters and the variaous stages of amethyst buds
