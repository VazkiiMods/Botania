...
* [ ] We are going to want to try to support world upgrades from 1.20, will need datafixers
  * [ ] Remove all random bits of legacy data support code
...
* [ ] Get rid of some enum-based behavioral changes:\
  ...
  * [ ] Natura pylon should be a separate subclass, and pylon type variants should not be enum references
...
* [ ] Leverage wind charge/burst tech for fall damage protection (e.g. skies rod, nimbus amulet, maybe even Feather Feet effect in general)
...
* [ ] Complete more block sets:
  ...
  * [ ] signs, hanging signs, doors, trapdoors (livingwood, dreamwqood, shimmerwood)
